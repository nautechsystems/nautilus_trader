...
class ConditionTests(unittest.TestCase):
    ...
    def test_condition_is_in_when_key_not_in_dictionary_raises_value_error(self):
        # Arrange
        # Act
        # Assert
    ...
    def test_condition_not_in_when_key_is_in_dictionary_raises_value_error(self):
        # Arrange
        # Act
        # Assert
