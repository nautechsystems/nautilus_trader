...
class ExecutionEngineTests(unittest.TestCase):
    ...
    def test_can_handle_order_fill_event(self):
        ...
        # Assert
        self.assertTrue(self.exec_db.position_exists(position_id))
        self.assertTrue(self.exec_db.is_position_active(position_id))
        ...
        self.assertTrue(position_id in self.exec_db.get_positions_active(strategy.id))
        self.assertTrue(position_id in self.exec_db.get_positions_active_all()[strategy.id])
    ...
    def test_can_add_to_existing_position_on_order_fill(self):
        ...
        self.assertEqual(1, len(self.exec_db.get_positions_active(strategy.id)))
        self.assertEqual(1, len(self.exec_db.get_positions_active_all()[strategy.id]))
        self.assertEqual(1, self.exec_db.positions_count())
        self.assertEqual(1, self.exec_db.positions_active_count())
        self.assertEqual(0, self.exec_db.positions_closed_count())
    ...
    def test_can_close_position_on_order_fill(self):
        ...
        # Assert
        self.assertTrue(self.exec_db.position_exists(position_id))
        self.assertFalse(self.exec_db.is_position_active(position_id))
        ...
        self.assertTrue(position_id in self.exec_db.get_positions_all())
        self.assertEqual(0, len(self.exec_db.get_positions_active(strategy.id)))
        self.assertEqual(0, len(self.exec_db.get_positions_active_all()[strategy.id]))
        ...
        self.assertTrue(position_id not in self.exec_db.get_positions_active(strategy.id))
        self.assertTrue(position_id not in self.exec_db.get_positions_active_all()[strategy.id])
        self.assertEqual(1, self.exec_db.positions_count())
    ...
    def test_multiple_strategy_positions_opened(self):
        ...
        self.assertTrue(self.exec_db.is_position_active(position_id1))
        self.assertTrue(self.exec_db.is_position_active(position_id2))
        ...
        self.assertEqual(1, len(self.exec_db.get_positions_active(strategy1.id)))
        self.assertEqual(1, len(self.exec_db.get_positions_active(strategy2.id)))
        self.assertEqual(2, len(self.exec_db.get_positions_active_all()))
        self.assertEqual(1, len(self.exec_db.get_positions_active_all()[strategy1.id]))
        self.assertEqual(1, len(self.exec_db.get_positions_active_all()[strategy2.id]))
        self.assertTrue(position_id1 in self.exec_db.get_positions_active(strategy1.id))
        self.assertTrue(position_id2 in self.exec_db.get_positions_active(strategy2.id))
        self.assertTrue(position_id1 in self.exec_db.get_positions_active_all()[strategy1.id])
