...
mod tests {
    ...
    fn test_add_single_order() {
        ...
        let order = BookOrder::new(OrderSide::Buy, Price::new(10.00, 2), Quantity::from(20), 0);
    ...
    fn test_add_multiple_buy_orders() {
        let mut ladder = Ladder::new(OrderSide::Buy);
        let order1 = BookOrder::new(OrderSide::Buy, Price::new(10.00, 2), Quantity::from(20), 0);
        let order2 = BookOrder::new(OrderSide::Buy, Price::new(9.00, 2), Quantity::from(30), 0);
        let order3 = BookOrder::new(OrderSide::Buy, Price::new(9.00, 2), Quantity::from(50), 0);
        let order4 = BookOrder::new(OrderSide::Buy, Price::new(8.00, 2), Quantity::from(200), 0);
    ...
    fn test_add_multiple_sell_orders() {
        ...
        let order1 = BookOrder::new(OrderSide::Sell, Price::new(11.00, 2), Quantity::from(20), 0);
        let order2 = BookOrder::new(OrderSide::Sell, Price::new(12.00, 2), Quantity::from(30), 0);
        let order3 = BookOrder::new(OrderSide::Sell, Price::new(12.00, 2), Quantity::from(50), 0);
    ...
    fn test_update_buy_order_price() {
        let mut ladder = Ladder::new(OrderSide::Buy);
        let order = BookOrder::new(OrderSide::Buy, Price::new(11.00, 2), Quantity::from(20), 1);

        ladder.add(order);

        let order = BookOrder::new(OrderSide::Buy, Price::new(11.10, 2), Quantity::from(20), 1);
    ...
    fn test_update_sell_order_price() {
        let mut ladder = Ladder::new(OrderSide::Sell);
        let order = BookOrder::new(OrderSide::Sell, Price::new(11.00, 2), Quantity::from(20), 1);

        ladder.add(order);

        let order = BookOrder::new(OrderSide::Sell, Price::new(11.10, 2), Quantity::from(20), 1);
    ...
    fn test_update_buy_order_size() {
        ...
        let order = BookOrder::new(OrderSide::Buy, Price::new(11.00, 2), Quantity::from(10), 1);
    ...
    fn test_update_sell_order_size() {
        ...
        let order = BookOrder::new(OrderSide::Sell, Price::new(11.00, 2), Quantity::from(10), 1);
    ...
    fn test_delete_sell_order() {
        let mut ladder = Ladder::new(OrderSide::Sell);
        let order = BookOrder::new(OrderSide::Sell, Price::new(10.00, 2), Quantity::from(10), 1);
