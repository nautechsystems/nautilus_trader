...
impl OrderCore {
    ...
    pub fn generate_order_submitted_event(
        &self,
    ...
    pub fn generate_order_accepted_event(
        &self,
        account_id: AccountId,
    ...
    pub fn generate_order_filled_event(
        &self,
        trade_id: TradeId,
        last_px: Price,
        last_qty: Quantity,
        ...
        Ok(OrderFilled::new(
            ...
            self.client_order_id,
            venue_order_id
                .or(self.venue_order_id)
                .expect("Venue Order ID missing"),
            account_id.or(self.account_id).expect("Account ID missing"),
            trade_id,
            self.side,
            self.order_type,
            last_qty,
            ...
            currency,
            liquidity_side
                .or(self.liquidity_side)
                .expect("Liquidity Side missing"),
            UUID4::new(),
            ts_filled_ns,
            UnixNanos::default(),
            false,
            position_id.or(self.position_id),
            commission,
        )
        .unwrap())
    }
