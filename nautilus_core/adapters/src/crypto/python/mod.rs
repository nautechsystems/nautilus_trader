...
use crate::crypto::python;

pub mod signing;

/// Loaded as nautilus_pyo3.crypto
#[pymodule]
pub fn crypto(py: Python, m: &PyModule) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(python::signing::py_hmac_sign, m)?)?;
