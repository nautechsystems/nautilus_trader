...
**Personal skills live in agent-specific directories such as `~/.agents/skills/` or another platform-specific skills directory.**
...
- Project-specific conventions (put in `AGENTS.md` or equivalent local instructions)
