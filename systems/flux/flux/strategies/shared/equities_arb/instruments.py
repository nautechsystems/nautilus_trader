...
if __name__ == "flux.strategies.shared.equities_arb.instruments":
    sys.modules.setdefault(
        "nautilus_trader.flux.strategies.shared.equities_arb.instruments",
        sys.modules[__name__],
    )
elif __name__ == "nautilus_trader.flux.strategies.shared.equities_arb.instruments":
    sys.modules.setdefault(
        "flux.strategies.shared.equities_arb.instruments",
        sys.modules[__name__],
    )
