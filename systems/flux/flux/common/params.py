...
_MAKERV3_RUNTIME_PARAM_SPECS: Final[tuple[RuntimeParamSpec, ...]] = (
    ...
    RuntimeParamSpec(
        ...
        schema_type="number",
        default=20.0,
        description="Global inventory-driven quoted FV adjustment cap in bps.",
        minimum=0.0,
        maximum=5_000.0,
    ),
    RuntimeParamSpec(
    ...
    RuntimeParamSpec(
        ...
        schema_type="number",
        default=0.0,
        description="Local inventory-driven quoted FV adjustment cap in bps.",
        minimum=0.0,
        maximum=5_000.0,
    ),
    RuntimeParamSpec(
        ...
        schema_type="number",
        default=0.0,
        description="Manual quoted FV adjustment in bps relative to the reference market (+ quote as if FV is higher, - quote as if FV is lower).",
        minimum=-5_000.0,
        maximum=5_000.0,
    ),
    RuntimeParamSpec(
