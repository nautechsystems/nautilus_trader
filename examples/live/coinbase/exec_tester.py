...
def main() -> None:
    ...
    account_type = account_type_from_name(args.account_type)
    ...
    if args.run:
        ...
        print("Built Coinbase exec tester node. Pass --run to connect.")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--account-id", default="COINBASE-001")
    parser.add_argument("--instrument", default=f"BTC-USDC.{COINBASE}")
...
def account_type_from_name(name: str) -> AccountType:
    if name == "margin":
