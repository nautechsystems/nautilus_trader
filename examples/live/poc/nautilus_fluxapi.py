...
PARAMS_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "hedge_qty": {"type": "number", "description": "Base quantity used by hedge leg (single-leg parity field)."},
    ...
    "bid_edge_hedge": {"type": "number", "description": "Hedge band 1 bid edge in bps."},
    "ask_edge_hedge": {"type": "number", "description": "Hedge band 1 ask edge in bps."},
    "distance_hedge": {"type": "number", "description": "Hedge band spacing increment in bps."},
    "n_orders_hedge": {"type": "integer", "description": "Hedge order depth per side."},
    "place_edge_hedge": {"type": "number", "description": "Hedge placement edge in bps."},
    "hedge_reduce_only": {"type": "boolean", "description": "Send reduce-only hedge orders when supported."},
    "hedge_touch_at_max_qty": {"type": "boolean", "description": "Allow hedge to cross/ touch near max-qty constraints."},
    "strategy_take_enabled": {"type": "boolean", "description": "Enable taker trigger mode."},
    "bid_edge_take": {"type": "number", "description": "Taker bid trigger threshold in bps from fair value."},
    "ask_edge_take": {"type": "number", "description": "Taker ask trigger threshold in bps from fair value."},
    "take_qty": {"type": "number", "description": "Taker size override (0=use qty)."},
    "take_cooldown": {"type": "number", "description": "Taker-only cooldown in seconds."},
