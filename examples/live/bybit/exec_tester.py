...
# -------------------------------------------------------------------------------------------------
"""
Test Bybit execution with the built-in ExecTester strategy.

WARNING: This example connects to Bybit mainnet and places REAL orders with REAL
...
INSTRUMENT_ID = InstrumentId.from_str(f"ETHUSDT-LINEAR.{BYBIT}")
