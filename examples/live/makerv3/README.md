...
- Production runner entrypoints live under `systems/flux/flux/runners/tokenmm/`.
...
Production management lives behind Pulse at `/pulse`.

- TokenMM multi-node deployment: `deploy/tokenmm/README.md`
- TokenMM UI serving runbook: `apps/fluxboard/docs/tokenmm_runbook.md`
