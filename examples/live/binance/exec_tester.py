...
# -------------------------------------------------------------------------------------------------
"""
Test Binance spot execution with the built-in ExecTester strategy.

WARNING: This example connects to Binance and places REAL orders with REAL funds.
On start it opens a position with an IOC order, then maintains post-only limit
buy quotes below the top of the book. On stop it cancels all orders and closes
