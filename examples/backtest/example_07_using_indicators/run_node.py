...
if __name__ == "__main__":
    """
    This example demonstrates how to use technical indicators with the high-level
    BacktestNode API.

    The strategy shows how to:
    - Create and use technical indicators (EMA in this case)
    - Process indicator values as new market data arrives
    - Store and access historical indicator values
    - Use indicators for trading decisions

    This helps you understand how to integrate technical analysis into your trading strategies.
    ...
    catalog_path = "./data_catalog_example_07"
