...
if __name__ == "__main__":
    """
    This example demonstrates how to use cache functionality with the high-level
    BacktestNode API.

    The strategy shows how to:
    - Store and retrieve custom objects in the cache
    - Use cache for persistent data across strategy runs
    - Access cached data during strategy execution
    - Demonstrate cache serialization capabilities

    This helps you understand how to work with cached data in your trading strategies.
    ...
    catalog_path = "./data_catalog_example_06"
    ...
    strategies = [
        ImportableStrategyConfig(
            strategy_path=CacheDemoStrategy.fully_qualified_name(),
            config_path=CacheDemoStrategyConfig.fully_qualified_name(),
            config={
    ...
    # Configure cache with database persistence
