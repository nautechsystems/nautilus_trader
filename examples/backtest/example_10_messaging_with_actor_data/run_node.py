...
if __name__ == "__main__":
    """
    This example demonstrates how to work with custom data classes and the Actor's
    publish/subscribe mechanism with the high-level BacktestNode API.

    The strategy shows how to:
    - Create custom data classes (both serializable and non-serializable)
    - Publish and subscribe to custom data using Actor methods
    - Handle custom data events in your strategy
    - Use custom data for inter-component communication

    This helps you understand how to implement custom data flows and communication
    patterns in your trading strategies.
    ...
    catalog_path = "./data_catalog_example_10"
    ...
    logging = LoggingConfig(
        log_level="DEBUG",  # Enable debug logging to see custom data events
    )
