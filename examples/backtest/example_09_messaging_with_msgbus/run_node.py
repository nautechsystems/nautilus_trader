...
if __name__ == "__main__":
    """
    This example demonstrates how to use message bus functionality with the high-level
    BacktestNode API.

    The strategy shows how to:
    - Create custom events using dataclasses
    - Publish events to the message bus
    - Subscribe to and handle custom events
    - Use the message bus for self-communication within a strategy

    This helps you understand how to implement publish/subscribe patterns for
    condition-based notifications in your trading strategies.
    ...
    catalog_path = "./data_catalog_example_09"
    ...
    logging = LoggingConfig(
        log_level="DEBUG",  # Enable debug logging to see message bus events
    )
