...
if __name__ == "__main__":
    """
    This example demonstrates the simplest form of messaging in NautilusTrader using
    actor-based signals with the high-level BacktestNode API.

    The strategy shows how to:
    - Use signals for simple notifications (price extremes in this case)
    - Publish signals with single string values
    - Subscribe to signals and handle them in on_signal callback
    - Implement lightweight notifications between components

    This helps you understand how to implement the simplest messaging patterns
    using string-based signals in your trading strategies.
    ...
    catalog_path = "./data_catalog_example_11"
    ...
    logging = LoggingConfig(
        log_level="DEBUG",  # Enable debug logging to see signal events
    )
