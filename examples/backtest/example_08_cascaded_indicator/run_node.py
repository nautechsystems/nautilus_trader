...
if __name__ == "__main__":
    """
    This example demonstrates how to use cascaded indicators with the high-level
    BacktestNode API.

    The strategy shows how to:
    - Create a primary indicator (EMA) that processes market data
    - Create a secondary indicator (EMA) that processes the primary indicator's output
    - Chain indicators together for more sophisticated analysis
    - Use cascaded indicators for trading decisions

    This helps you understand how to build complex indicator chains in your trading strategies.
    ...
    catalog_path = "./data_catalog_example_08"
    ...
    logging = LoggingConfig(
        log_level="DEBUG",  # Enable debug logging to see indicator calculations
    )
