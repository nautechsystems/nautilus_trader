...
catalog_folder = "20241013_Test_Histo_Bars"
...
# %%
len(futures_data_quotes["nautilus_data"])

# %%
futures_data_trades["nautilus_data"]
...
class TestHistoAggStrategy(Strategy):
    ...
    def on_start(self):
        ...
        # composite_bar_type = BarType.from_str(
        #     f"{self._symbol_id}-2-MINUTE-LAST-INTERNAL@1-MINUTE-EXTERNAL",
        # )
        # self.subscribe_bars(composite_bar_type)

        # self.subscribe_bars(
        #     BarType.from_str(f"{self._symbol_id}-4-MINUTE-LAST-INTERNAL@2-MINUTE-INTERNAL"),
        # )

        # self.subscribe_bars(
        #     BarType.from_str(f"{self._symbol_id}-5-MINUTE-LAST-INTERNAL@1-MINUTE-EXTERNAL"),
        # )

        # self.request_bars(external_bar_type, start=start_histo_bars, end=end_histo_bars)
        ...
        # self.subscribe_bars(
        #     BarType.from_str(f"{self._symbol_id}-1-MINUTE-BID-INTERNAL"),
        # )

        # self.subscribe_bars(
        #     BarType.from_str(f"{self._symbol_id}-2-MINUTE-BID-INTERNAL@1-MINUTE-INTERNAL"),
        # )

        # self.request_quote_ticks(
        #     InstrumentId.from_str(f"{self._symbol_id}"),
        ...
        self.subscribe_bars(
            BarType.from_str(f"{self._symbol_id}-1-MINUTE-LAST-INTERNAL"),
        )

        self.subscribe_bars(
            BarType.from_str(f"{self._symbol_id}-2-MINUTE-LAST-INTERNAL@1-MINUTE-INTERNAL"),
        )
