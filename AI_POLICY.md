...
can explain every part. Do not submit speculative, untested, or unnecessarily complex output for
maintainers to validate.

A human must choose the work, direct the implementation, verify the result, and authorize and
remain accountable for every public interaction with GitHub. Fully autonomous contributions, where
an agent acts without meaningful human direction and review, are not accepted.
