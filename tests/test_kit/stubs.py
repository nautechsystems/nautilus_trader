...
class TestExecStubs:
    ...
    def cash_account():
        return AccountFactory.create(
            TestEventStubs.event_cash_account_state(account_id=TestIdStubs.account_id())
        )

    @staticmethod
    def margin_account():
        return AccountFactory.create(
            TestEventStubs.event_margin_account_state(account_id=TestIdStubs.account_id())
        )

    @staticmethod
    def betting_account(account_id=None):
        return AccountFactory.create(
            TestEventStubs.event_betting_account_state(
                account_id=account_id or TestIdStubs.account_id()
            )
        )
