...
class TestBybitFactories:
    ...
    @pytest.mark.parametrize(
        ...
        [
            [BybitAccountType.SPOT,True, "wss://stream.bybit.com/v5/public/spot"],
            [BybitAccountType.SPOT,False, "wss://stream-testnet.bybit.com/v5/public/spot"],
            [BybitAccountType.LINEAR,True, "wss://stream.bybit.com/v5/public/linear"],
            [BybitAccountType.LINEAR,False, "wss://stream-testnet.bybit.com/v5/public/linear"],
            [BybitAccountType.INVERSE,True, "wss://stream.bybit.com/v5/public/inverse"],
            [BybitAccountType.INVERSE,False, "wss://stream-testnet.bybit.com/v5/public/inverse"],
        ]
    )
