...
def _create_ws_mock() -> MagicMock:
    ...
    mock.submit_order = AsyncMock(return_value=None)
    mock.submit_orders = AsyncMock(return_value=[])
    mock.modify_order = AsyncMock()
    mock.cancel_order = AsyncMock()
    ...
    mock.subscribe_book_snapshots = AsyncMock()
    mock.subscribe_trades = AsyncMock()
    mock.subscribe_public_trades = AsyncMock()
    ...
    mock.unsubscribe_book_snapshots = AsyncMock()
    mock.unsubscribe_trades = AsyncMock()
    mock.unsubscribe_public_trades = AsyncMock()
