...
class UUIDTests(unittest.TestCase):
    ...
    def test_instantiate_with_invalid_value(self):
        # Arrange
        # Act
        # Assert
        self.assertRaises(ValueError, UUID, "12345678-1234-5678-1234-56781234567")

    def test_instantiate_with_value(self):
        # Arrange
        # Act
        uuid = UUID(value="12345678-1234-5678-1234-567812345678")
        # Assert
        self.assertEqual("12345678-1234-5678-1234-567812345678", uuid.value)

    def test_from_str(self):
        # Arrange
        # Act
        uuid = UUID.from_str("12345678-1234-5678-1234-567812345678")

        # Assert
        self.assertEqual("12345678-1234-5678-1234-567812345678", uuid.value)

    # TODO: Temporary use of limited functionality rust derived UUID
