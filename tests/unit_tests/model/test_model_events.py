...
class TestEvents:
    ...
    def test_order_initialized_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(event)
            == f"OrderInitialized(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, side=BUY, type=LIMIT, quantity=0.561000, options={{'price': '15200.10'}}, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_denied_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            repr(event)
            == f"OrderDenied(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, reason=Exceeded MAX_ORDER_RATE, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_submitted_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderSubmitted(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, account_id=SIM-000, ts_submitted_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderSubmitted(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, account_id=SIM-000, ts_submitted_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_accepted_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderAccepted(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_accepted_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderAccepted(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_accepted_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_rejected_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderRejected(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=NULL, account_id=SIM-000, reason='INSUFFICIENT_MARGIN', ts_accepted_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderRejected(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=NULL, account_id=SIM-000, reason='INSUFFICIENT_MARGIN', ts_accepted_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_canceled_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderCanceled(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_canceled_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderCanceled(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_canceled_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_expired_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderExpired(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_expired_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderExpired(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_expired_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_triggered_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderTriggered(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_triggered_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderTriggered(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_triggered_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_pending_update_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderPendingUpdate(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_pending_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderPendingUpdate(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_pending_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_pending_cancel_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderPendingCancel(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_pending_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderPendingCancel(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, ts_pending_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_update_rejected_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderUpdateRejected(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, response_to=O-2020872378423, reason=ORDER_DOES_NOT_EXIST, ts_rejected_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderUpdateRejected(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, response_to=O-2020872378423, reason=ORDER_DOES_NOT_EXIST, ts_rejected_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_cancel_rejected_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderCancelRejected(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, response_to=O-2020872378423, reason=ORDER_DOES_NOT_EXIST, ts_rejected_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderCancelRejected(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, response_to=O-2020872378423, reason=ORDER_DOES_NOT_EXIST, ts_rejected_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
    ...
    def test_order_filled_event_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(event)
            == "OrderFilled(instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, execution_id=1, position_id=2, side=BUY-MAKER, type=LIMIT, last_qty=0.561000, last_px=15600.12445 USDT, commission=12.20000000 USDT, ts_filled_ns=0)"  # noqa
        )
        assert (
            repr(event)
            == f"OrderFilled(trader_id=TRADER-001, strategy_id=SCALPER-001, instrument_id=BTC/USDT.BINANCE, client_order_id=O-2020872378423, venue_order_id=123456, account_id=SIM-000, execution_id=1, position_id=2, side=BUY-MAKER, type=LIMIT, last_qty=0.561000, last_px=15600.12445 USDT, commission=12.20000000 USDT, ts_filled_ns=0, event_id={uuid}, timestamp_ns=0)"  # noqa
        )
