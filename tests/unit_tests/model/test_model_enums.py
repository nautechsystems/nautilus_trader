...
class BarAggregationTests(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        [BarAggregation.NOTIONAL, "NOTIONAL"],
        [BarAggregation.NOTIONAL_IMBALANCE, "NOTIONAL_IMBALANCE"],
        [BarAggregation.NOTIONAL_RUNS, "NOTIONAL_RUNS"],
    ...
    @parameterized.expand([
        ...
        ["NOTIONAL", BarAggregation.NOTIONAL],
        ["NOTIONAL_IMBALANCE", BarAggregation.NOTIONAL_IMBALANCE],
        ["NOTIONAL_RUNS", BarAggregation.NOTIONAL_RUNS],
