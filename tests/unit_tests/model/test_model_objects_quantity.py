...
class QuantityTests(unittest.TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual("1,000", Quantity(1000).to_string())
        self.assertEqual("1,112", Quantity(1112).to_string())
        self.assertEqual("120,100", Quantity("120100").to_string())
        self.assertEqual("200,000", Quantity("200000").to_string())
        self.assertEqual("1,000,000", Quantity("1000000").to_string())
        self.assertEqual("2,500,000", Quantity("2500000").to_string())
        self.assertEqual("1,111,111", Quantity("1111111").to_string())
        self.assertEqual("2,523,000", Quantity("2523000").to_string())
        self.assertEqual("100,000,000", Quantity("100000000").to_string())
