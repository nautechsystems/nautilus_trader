...
class ExecutionEngineTests(unittest.TestCase):
    ...
    def test_handle_order_fill_event(self):
        ...
        self.assertTrue(expected_position_id in self.exec_db.get_positions())
        self.assertTrue(expected_position_id not in self.exec_db.get_positions_closed(strategy_id=strategy.id))
        self.assertTrue(expected_position_id not in self.exec_db.get_positions_closed())
        self.assertTrue(expected_position_id in self.exec_db.get_positions_open(strategy_id=strategy.id))
        self.assertTrue(expected_position_id in self.exec_db.get_positions_open())
    ...
    def test_handle_position_opening_with_position_id_none(self):
        ...
        self.assertTrue(expected_id not in self.exec_db.get_positions_closed(strategy_id=strategy.id))
        self.assertTrue(expected_id not in self.exec_db.get_positions_closed())
        self.assertTrue(expected_id in self.exec_db.get_positions_open(strategy_id=strategy.id))
    ...
    def test_close_position_on_order_fill(self):
        ...
        self.assertTrue(position_id in self.exec_db.get_positions(strategy_id=strategy.id))
        ...
        self.assertTrue(position_id in self.exec_db.get_positions_closed(strategy_id=strategy.id))
        self.assertTrue(position_id in self.exec_db.get_positions_closed())
        self.assertTrue(position_id not in self.exec_db.get_positions_open(strategy_id=strategy.id))
    ...
    def test_multiple_strategy_positions_opened(self):
        ...
        self.assertTrue(position1_id in self.exec_db.get_positions(strategy_id=strategy1.id))
        self.assertTrue(position2_id in self.exec_db.get_positions(strategy_id=strategy2.id))
        ...
        self.assertEqual(1, len(self.exec_db.get_positions_open(strategy_id=strategy1.id)))
        self.assertEqual(1, len(self.exec_db.get_positions_open(strategy_id=strategy2.id)))
        self.assertTrue(position1_id in self.exec_db.get_positions_open(strategy_id=strategy1.id))
        self.assertTrue(position2_id in self.exec_db.get_positions_open(strategy_id=strategy2.id))
        ...
        self.assertTrue(position1_id not in self.exec_db.get_positions_closed(strategy_id=strategy1.id))
        self.assertTrue(position2_id not in self.exec_db.get_positions_closed(strategy_id=strategy2.id))
    ...
    def test_multiple_strategy_positions_one_active_one_closed(self):
        ...
        self.assertFalse(self.exec_engine.is_flat(strategy_id=strategy2.id))
        self.assertFalse(self.exec_engine.is_flat())
        self.assertTrue(position_id1 in self.exec_db.get_positions(strategy_id=strategy1.id))
        self.assertTrue(position_id2 in self.exec_db.get_positions(strategy_id=strategy2.id))
        ...
        self.assertTrue(position_id1 not in self.exec_db.get_positions_open(strategy_id=strategy1.id))
        self.assertTrue(position_id2 in self.exec_db.get_positions_open(strategy_id=strategy2.id))
        ...
        self.assertTrue(position_id1 in self.exec_db.get_positions_closed(strategy_id=strategy1.id))
        self.assertTrue(position_id2 not in self.exec_db.get_positions_closed(strategy_id=strategy2.id))
