...
class TestCommands:
    ...
    def test_submit_order_command_from_dict_and_str_repr(self):
        ...
        assert (
            str(command)
            == "SubmitOrder(order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, tags=None), position_id=P-001, exec_algorithm_spec=None)"  # noqa
        )
        assert (
            repr(command)
            == f"SubmitOrder(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-19700101-000000-000-001-1, order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, tags=None), position_id=P-001, exec_algorithm_spec=None, command_id={uuid}, ts_init=0)"  # noqa
        )
    ...
    def test_submit_order_command_with_exec_algorithm_spec_from_dict_and_str_repr(self):
        ...
        assert (
            str(command)
            == "SubmitOrder(order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, tags=None), position_id=P-001, exec_algorithm_spec=ExecAlgorithmSpecification(client_order_id=O-123456789, exec_algorithm_id=VWAP, params={'max_percentage': 100.0, 'start': 0, 'end': 1}))"  # noqa
        )
        assert (
            repr(command)
            == f"SubmitOrder(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-19700101-000000-000-001-1, order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, tags=None), position_id=P-001, exec_algorithm_spec=ExecAlgorithmSpecification(client_order_id=O-123456789, exec_algorithm_id=VWAP, params={{'max_percentage': 100.0, 'start': 0, 'end': 1}}), command_id={uuid}, ts_init=0)"  # noqa
        )
    ...
    def test_submit_bracket_order_command_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(command)
            == "SubmitOrderList(order_list=OrderList(id=1, instrument_id=AUD/USD.SIM, orders=[MarketOrder(BUY 100_000 AUD/USD.SIM MARKET GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, contingency_type=OTO, linked_order_ids=[O-19700101-000000-000-001-2, O-19700101-000000-000-001-3], tags=ENTRY), StopMarketOrder(SELL 100_000 AUD/USD.SIM STOP_MARKET @ 1.00000[DEFAULT] GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-2, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-3], tags=STOP_LOSS), LimitOrder(SELL 100_000 AUD/USD.SIM LIMIT @ 1.00100 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-3, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-2], tags=TAKE_PROFIT)]), position_id=P-001, exec_algorithm_specs=None)"  # noqa
        )
        assert (
            repr(command)
            == f"SubmitOrderList(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, order_list=OrderList(id=1, instrument_id=AUD/USD.SIM, orders=[MarketOrder(BUY 100_000 AUD/USD.SIM MARKET GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, contingency_type=OTO, linked_order_ids=[O-19700101-000000-000-001-2, O-19700101-000000-000-001-3], tags=ENTRY), StopMarketOrder(SELL 100_000 AUD/USD.SIM STOP_MARKET @ 1.00000[DEFAULT] GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-2, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-3], tags=STOP_LOSS), LimitOrder(SELL 100_000 AUD/USD.SIM LIMIT @ 1.00100 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-3, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-2], tags=TAKE_PROFIT)]), position_id=P-001, exec_algorithm_specs=None, command_id={uuid}, ts_init=0)"  # noqa
        )
    ...
    def test_submit_bracket_order_command_with_exec_algorithm_specs_to_from_dict_and_str_repr(self):
        ...
        assert (
            str(command)
            == "SubmitOrderList(order_list=OrderList(id=1, instrument_id=AUD/USD.SIM, orders=[MarketOrder(BUY 100_000 AUD/USD.SIM MARKET GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, contingency_type=OTO, linked_order_ids=[O-19700101-000000-000-001-2, O-19700101-000000-000-001-3], tags=ENTRY), StopMarketOrder(SELL 100_000 AUD/USD.SIM STOP_MARKET @ 1.00000[DEFAULT] GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-2, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-3], tags=STOP_LOSS), LimitOrder(SELL 100_000 AUD/USD.SIM LIMIT @ 1.00100 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-3, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-2], tags=TAKE_PROFIT)]), position_id=P-001, exec_algorithm_specs=[ExecAlgorithmSpecification(client_order_id=O-19700101-000000-000-001-1, exec_algorithm_id=VWAP, params={'max_percentage': 100.0, 'start': 0, 'end': 1})])"  # noqa
        )
        assert (
            repr(command)
            == f"SubmitOrderList(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, order_list=OrderList(id=1, instrument_id=AUD/USD.SIM, orders=[MarketOrder(BUY 100_000 AUD/USD.SIM MARKET GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-1, venue_order_id=None, contingency_type=OTO, linked_order_ids=[O-19700101-000000-000-001-2, O-19700101-000000-000-001-3], tags=ENTRY), StopMarketOrder(SELL 100_000 AUD/USD.SIM STOP_MARKET @ 1.00000[DEFAULT] GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-2, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-3], tags=STOP_LOSS), LimitOrder(SELL 100_000 AUD/USD.SIM LIMIT @ 1.00100 GTC, status=INITIALIZED, client_order_id=O-19700101-000000-000-001-3, venue_order_id=None, contingency_type=OUO, parent_order_id=O-19700101-000000-000-001-1, linked_order_ids=[O-19700101-000000-000-001-2], tags=TAKE_PROFIT)]), position_id=P-001, exec_algorithm_specs=[ExecAlgorithmSpecification(client_order_id=O-19700101-000000-000-001-1, exec_algorithm_id=VWAP, params={{'max_percentage': 100.0, 'start': 0, 'end': 1}})], command_id={uuid}, ts_init=0)"  # noqa
        )
