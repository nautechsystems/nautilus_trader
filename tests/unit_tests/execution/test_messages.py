...
class TestCommands:
    ...
    def test_submit_order_command_from_dict_and_str_repr(self):
        ...
        assert (
            str(command)
            == "SubmitOrder(order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-0000-000-001-1, venue_order_id=None, position_id=None, tags=None), position_id=P-001)"  # noqa
        )
        assert (
            repr(command)
            == f"SubmitOrder(client_id=None, trader_id=TRADER-001, strategy_id=S-001, instrument_id=AUD/USD.SIM, client_order_id=O-19700101-0000-000-001-1, order=LimitOrder(BUY 100_000 AUD/USD.SIM LIMIT @ 1.00000 GTC, status=INITIALIZED, client_order_id=O-19700101-0000-000-001-1, venue_order_id=None, position_id=None, tags=None), position_id=P-001, command_id={uuid}, ts_init=0)"  # noqa
        )
