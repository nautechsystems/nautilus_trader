...
CREATE TABLE IF NOT EXISTS "order" (
    ...
    venue_order_id TEXT DEFAULT NULL,
    position_id TEXT DEFAULT NULL,
    account_id TEXT REFERENCES account(id) ON DELETE CASCADE,
    last_trade_id TEXT DEFAULT NULL,
    order_type TEXT NOT NULL,
    order_side TEXT NOT NULL,
    quantity TEXT NOT NULL,
    price TEXT DEFAULT NULL,
    trigger_price TEXT DEFAULT NULL,
    trigger_type TEXT DEFAULT NULL,
    limit_offset TEXT DEFAULT NULL,
    trailing_offset TEXT DEFAULT NULL,
    trailing_offset_type TEXT DEFAULT NULL,
    time_in_force TEXT NOT NULL,
    expire_time TEXT DEFAULT NULL,
    filled_qty TEXT DEFAULT '0',
    liquidity_side TEXT DEFAULT NULL,
    avg_px FLOAT DEFAULT NULL,
    ...
    is_quote_quantity BOOLEAN DEFAULT FALSE,
    display_qty TEXT DEFAULT NULL,
    emulation_trigger TEXT DEFAULT NULL,
    trigger_instrument_id TEXT DEFAULT NULL,
    contingency_type TEXT DEFAULT NULL,
    order_list_id TEXT DEFAULT NULL,
    linked_order_ids TEXT[] DEFAULT NULL,
    parent_order_id TEXT DEFAULT NULL,
    exec_algorithm_id TEXT DEFAULT NULL,
    exec_algorithm_params JSONB DEFAULT NULL,
