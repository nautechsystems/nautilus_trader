...
from nautilus_trilus_trader.core.nautilus_pyo3 import BarType
...
class CacheFacade:
    ...
    def positions(self, venue: Venue | None = None, instrument_id: InstrumentId | None = None, strategy_id: StrategyId | None = None, side: PositionSide = PositionSide.FLAT) -> list[Position]: ...
    def position_exists(self, position_id: PositionId) -> bool: ...
    def positions_open(self, venue: Venue | None = None, instrument_id: InstrumentId | None = None, strategy_id: StrategyId | None = None, side: PositionSide = PositionSide.FLAT) -> list[Position]: ...
    ...
    def positions_open_count(self, venue: Venue | None = None, instrument_id: InstrumentId | None = None, strategy_id: StrategyId | None = None, side: PositionSide = PositionSide.FLAT) -> int: ...
    ...
    def positions_total_count(self, venue: Venue | None = None, instrument_id: InstrumentId | None = None, strategy_id: StrategyId | None = None, side: PositionSide = PositionSide.FLAT) -> int: ...
