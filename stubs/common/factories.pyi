...
class OrderFactory:
    ...
    def bracket(
        ...
        tp_trigger_type: TriggerType = TriggerType.DEFAULT,
        tp_activation_price: Price | None = None,
        tp_trailing_offset: Decimal | None = None,
        tp_trailing_offset_type: TrailingOffsetType = TrailingOffsetType.PRICE,
        ...
        sl_trailing_offset_type: TrailingOffsetType = TrailingOffsetType.PRICE,
