...
| `submitted_order_exhaustion_policy`  | `RESOLVE_LOCALLY` | Set `SubmittedOrderExhaustionPolicy.RETAIN_UNRESOLVED` to preserve unknown submissions after bounded recovery. See [Retaining unresolved submissions](../concepts/execution/policies.md#retaining-unresolved-submissions). |
