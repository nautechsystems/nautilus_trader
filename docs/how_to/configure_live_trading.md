...
| Setting                              | Default        | Description                                                                                                                                                                                    |
| ------------------------------------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `reconciliation_fail_closed`         | False          | Stop the trader and live node when any continuous order/position report query fails, times out, or has incomplete targeted coverage.                                                          |
