...
| Setting                              | Default        | Description                                                                                                                                                                                    |
| ------------------------------------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `reconciliation_fail_closed`         | False          | Require complete reconciliation; abort when startup coverage is unavailable; fence submits/modifies and stop on continuous authority loss.                                                     |
