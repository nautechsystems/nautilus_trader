...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | completed | main | none | `tooling/dev/**`, `scripts/sync_upstream.sh`, `.gitignore`, `docs/plans/2026-03-19-nautilus-upstream-upgrade*`, `docs/runbooks/**`, `docs/reviews/**` | `codex/nautilus-upstream-upgrade-20260319` | `/home/ubuntu/nautilus_trader/.worktrees/nautilus-upstream-upgrade-20260319` | `30058a9b20..b98b227584` | `bash tooling/dev/test-prepare-nautilus-upgrade.sh PASS; bash -n tooling/dev/prepare-nautilus-upgrade.sh PASS; bash -n scripts/sync_upstream.sh PASS; git diff --check PASS` | Tooling, docs, and first branch-prep evidence implemented and verified in the controller worktree |
...
| Task 4: Verify and close out documentation | completed | main | Task 2: Add runbook and evidence template, Task 3: Prepare the first upgrade branch and report | `docs/plans/2026-03-19-nautilus-upstream-upgrade.md` | `codex/nautilus-upstream-upgrade-20260319` | `/home/ubuntu/nautilus_trader/.worktrees/nautilus-upstream-upgrade-20260319` | `b98b227584` | `bash tooling/dev/test-prepare-nautilus-upgrade.sh PASS; bash -n tooling/dev/prepare-nautilus-upgrade.sh PASS; bash -n scripts/sync_upstream.sh PASS; git diff --check PASS` | Final verification pass completed and tracker closed out on the controller branch |
