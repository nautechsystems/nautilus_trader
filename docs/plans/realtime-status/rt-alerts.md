...
- next handoff: `Alerts is resolved for Task 15. Balances remains the only active cleanup blocker before Task 13 can begin; MarketData stays parked from the active cleanup wave.`
