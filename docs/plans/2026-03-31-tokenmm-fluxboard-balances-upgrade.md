...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | in_progress | main | none | `fluxboard/Balances.tsx`, `fluxboard/types.ts`, `fluxboard/api.ts`, `fluxboard/api.flux.test.ts`, `fluxboard/Balances.test.tsx`, `fluxboard/__tests__/realtime/market-balances-standard.test.tsx`, `fluxboard/components/balances/*`, `systems/flux/flux/api/app.py`, `systems/flux/flux/api/_payloads_balances.py` | `codex/tokenmm-fluxboard-balances-upgrade` | `/home/ubuntu/nautilus_trader/.worktrees/tokenmm-fluxboard-balances-upgrade` | `bc4a3f8a68`, `e820a8f927`, `309949d45a` | `cd fluxboard && pnpm vitest run api.flux.test.ts components/balances/tokenmmBalancesModel.test.ts Balances.test.tsx` -> PASS (`67 passed`) | 2026-03-31 UTC: batch 1 (Tasks 1-3) is complete and verified; stopping here for review before Task 4 live-update coverage |
| Task 1: Add typed TokenMM balances metadata and view-model scaffolding | completed | main | none | `fluxboard/types.ts`, `fluxboard/api.ts`, `fluxboard/api.flux.test.ts`, `fluxboard/components/balances/tokenmmBalancesModel.ts`, `fluxboard/components/balances/tokenmmBalancesModel.test.ts` | `codex/tokenmm-fluxboard-balances-upgrade` | `/home/ubuntu/nautilus_trader/.worktrees/tokenmm-fluxboard-balances-upgrade` | `bc4a3f8a68` | `pnpm install --frozen-lockfile` -> PASS; `cd fluxboard && pnpm vitest run api.flux.test.ts components/balances/tokenmmBalancesModel.test.ts` -> PASS (`59 passed`) | 2026-03-31 UTC: inventory metadata is typed/normalized, RED->GREEN model scaffolding landed, and the branch-local tracker is now committed |
| Task 2: Implement freshness, type, section, and summary derivation | completed | main | Task 1: Add typed TokenMM balances metadata and view-model scaffolding | `fluxboard/components/balances/tokenmmBalancesModel.ts`, `fluxboard/components/balances/tokenmmBalancesModel.test.ts` | `codex/tokenmm-fluxboard-balances-upgrade` | `/home/ubuntu/nautilus_trader/.worktrees/tokenmm-fluxboard-balances-upgrade` | `e820a8f927` | `cd fluxboard && pnpm vitest run components/balances/tokenmmBalancesModel.test.ts` -> PASS (`7 passed`) | 2026-03-31 UTC: freshness/status, deterministic section/filter/sort outputs, summaries, and expansion reconciliation now live in the pure model layer |
| Task 3: Rebuild the Balances page around TokenMM-specific holdings UI | completed | main | Task 2: Implement freshness, type, section, and summary derivation | `fluxboard/Balances.tsx`, `fluxboard/components/balances/BalanceStatusBadge.tsx`, `fluxboard/components/balances/TokenMMBalancesStatusStrip.tsx`, `fluxboard/components/balances/TokenMMBalancesSummary.tsx`, `fluxboard/components/balances/TokenMMBalancesToolbar.tsx`, `fluxboard/components/balances/TokenMMBalancesTable.tsx`, `fluxboard/Balances.test.tsx` | `codex/tokenmm-fluxboard-balances-upgrade` | `/home/ubuntu/nautilus_trader/.worktrees/tokenmm-fluxboard-balances-upgrade` | `309949d45a` | `cd fluxboard && pnpm vitest run Balances.test.tsx` -> PASS (`6 passed`) | 2026-03-31 UTC: Balances is now a TokenMM-only holdings surface with status strip, inventory-only summaries, toolbar filters, grouped sections, and parent/child drilldown tables backed by the pure display model |
