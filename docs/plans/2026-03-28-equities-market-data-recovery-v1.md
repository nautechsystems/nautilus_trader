...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | completed | controller | Task 1-6 | docs/plans/2026-03-28-equities-market-data-recovery-v1.md | fix/equities-market-data-recovery-v1-impl-20260328 | /home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328 | c27dbd61c6 | `BUILD_MODE=debug CARGO_TARGET_DIR=/home/ubuntu/nautilus_trader/target uv run --active --no-sync build.py` PASS; `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_readiness.py -k 'down'` PASS (`1 passed, 22 deselected`); all task-level verification recorded in the rows below | 2026-03-28: Controller worktree created from plan/equities-market-data-recovery-v1-20260328 at 8b45a58700 and all six reviewed V1 tasks are now integrated through `c27dbd61c6`. Scope stayed within node-scoped recovery ownership plus Hyperliquid/Binance maker-feed hardening, with rollout docs tightened to reflect the additional intra-node/IBKR-boundary review context. |
| Task 1: Add A Strategy Attachment Seam And Node-Scoped Quote Feed Supervisor Contract | completed | controller | none | systems/flux/flux/runners/shared/quote_feed_supervisor.py; systems/flux/flux/runners/equities/run_node.py; systems/flux/flux/strategies/makerv4/strategy.py; tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py; tests/unit_tests/examples/strategies/test_equities_run_node.py; tests/unit_tests/flux/strategies/equities_maker/test_strategy.py | fix/equities-market-data-recovery-v1-impl-20260328 | /home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328 | 795c25b262 + 6da6030182 + ef8b101cec + 978bebebd7 | `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_node.py -k 'shared_recovery or schedule_quote_feed_result_on_node_loop'` PASS (`4 passed, 52 deselected`); `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py tests/unit_tests/examples/strategies/test_equities_run_node.py tests/unit_tests/flux/strategies/equities_maker/test_strategy.py` PASS (`73 passed`); `git diff --check` PASS | 2026-03-28: Spec Reviewer the 6th returned “No Task 1 spec findings.”, Quality Reviewer the 6th surfaced the closed-loop scheduling bug, 978bebebd7 fixed it, and the final controller quality sweep found no remaining Task 1 issues on the four-commit chain |
| Task 2: Rewire MakerV4 To Use Shared Recovery Ownership For Full Quote Lifecycle | completed | controller | Task 1 | systems/flux/flux/runners/equities/run_node.py; systems/flux/flux/runners/shared/quote_feed_supervisor.py; systems/flux/flux/strategies/makerv4/strategy.py; systems/flux/flux/strategies/equities_taker/strategy.py; tests/unit_tests/examples/strategies/test_equities_run_node.py; tests/unit_tests/flux/strategies/equities_maker/test_strategy.py; tests/unit_tests/flux/strategies/equities_taker/test_strategy.py | lanes/task-2-shared-recovery | /home/ubuntu/nautilus_trader/.worktrees/task-2-shared-recovery | 59e1a44f90 (integrated from lane 8bf4249347) | `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_node.py -k 'shared_recovery or schedule_quote_feed_result_on_node_loop or non_node_scoped_reference_feed_live_on_start_and_stop'` PASS (`5 passed, 52 deselected`); `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py` PASS (`16 passed`); `./.venv.py312/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/flux/strategies/equities_maker/test_strategy.py` PASS (`16 passed`); `./.venv.py312/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/flux/strategies/equities_taker/test_strategy.py` PASS (`12 passed`); `git diff --check` PASS | 2026-03-28: Fresh quality review found no remaining Task 2 quality issues after the startup-retry and dynamic-budget fixes. Residual risk is limited to end-to-end live adapter result/blocker producers, which remain tracked under the Task 3 live seam work. |
| Task 3: Harden Hyperliquid Recovery Semantics | completed | controller | Task 1 | crates/adapters/hyperliquid/src/python/websocket.rs; crates/adapters/hyperliquid/src/websocket/client.rs; nautilus_trader/adapters/hyperliquid/data.py; crates/adapters/hyperliquid/tests/http.rs; crates/adapters/hyperliquid/tests/websocket.rs; tests/integration_tests/adapters/hyperliquid/test_data.py; nautilus_trader/adapters/hyperliquid/factories.py; systems/flux/flux/runners/equities/run_node.py; systems/flux/flux/runners/shared/quote_feed_supervisor.py; tests/unit_tests/examples/strategies/test_equities_run_node.py; tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py | lanes/task-3-hyperliquid-recovery-r3 | /home/ubuntu/nautilus_trader/.worktrees/task-3-hyperliquid-recovery-r3 | 65884707f6 (fast-forward integrated from lane) | `cargo test -p nautilus-hyperliquid --test http recovery -- --nocapture` PASS (`1 passed`); `cargo test -p nautilus-hyperliquid --test websocket recovery -- --nocapture` PASS (`5 passed`); `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python build.py` PASS; `TMPDIR=/home/ubuntu/nautilus_trader/.worktrees/task-3-hyperliquid-recovery-r3/.tmp /home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/integration_tests/adapters/hyperliquid/test_data.py -k 'recovery or cache or subscribe_quotes or feed_identity'` PASS (`2 passed, 17 deselected`); `TMPDIR=/home/ubuntu/nautilus_trader/.worktrees/task-3-hyperliquid-recovery-r3/.tmp /home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_node.py -k 'wraps_hyperliquid_data_factory or preserves_extra_result_payload or routes_explicit_feed_identity or feed_identity_recovery or does_not_duplicate_result or ingest_result or blocker or recovery'` PASS (`7 passed, 56 deselected`); `TMPDIR=/home/ubuntu/nautilus_trader/.worktrees/task-3-hyperliquid-recovery-r3/.tmp /home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py -k 'ingest_result or blocker or recovery'` PASS (`8 passed, 9 deselected`); `python3 -m py_compile` PASS on touched supervisor files; `git diff --check` PASS | 2026-03-28: Fast-forward integrated Task 3 at 65884707f6 after fresh spec re-review on `ccdebd8270..65884707f6` and final quality review on `0bf5ee836a..65884707f6` both returned no findings. Residual risk is low: coverage is split across unit layers rather than one end-to-end Rust-to-Python recovery test. |
| Task 4: Harden Binance Recovery Semantics | completed | controller | Task 1 | nautilus_trader/adapters/binance/data.py; nautilus_trader/adapters/binance/websocket/client.py; tests/unit_tests/adapters/binance/test_data_recovery.py | lanes/task-4-binance-recovery | /home/ubuntu/nautilus_trader/.worktrees/task-4-binance-recovery | a29bacf62b + ccdebd8270 (lane 4b61728d79 reconciled on controller) | Lane `./.venv.py312/bin/python -m pytest -q tests/unit_tests/adapters/binance/test_data_recovery.py -k 'recovery or book_ticker or subscribe'` PASS (`16 passed`); lane `./.venv.py312/bin/python -m pytest -q tests/unit_tests/adapters/binance` PASS (`36 passed`); controller `./.venv.py312/bin/python -m pytest -q tests/unit_tests/adapters/binance/test_data_recovery.py -k 'recovery or book_ticker or subscribe'` PASS (`16 passed`); controller `./.venv.py312/bin/python -m pytest -q tests/unit_tests/adapters/binance` PASS (`36 passed`); `git diff --check` PASS | 2026-03-28: Fresh controller spec and quality sweeps on `a29bacf62b..ccdebd8270` found no remaining Task 4 defects. Residual risk remains narrow: same-version replay reuse still assumes unexpected transport-health changes surface via a stream-version bump if the native websocket layer ever reconnects without traversing the version-bumping paths. |
| Task 5: Add Honest Recovering-State Semantics Without Regressing Down-State Behavior | completed | controller | Task 2, Task 3, Task 4 | systems/flux/flux/api/_payloads_signals.py; tests/unit_tests/flux/api/test_payloads.py; tests/unit_tests/examples/strategies/test_equities_readiness.py; tests/unit_tests/flux/api/test_equities_profile_contract.py | lanes/task-5-recovering-payloads | /home/ubuntu/nautilus_trader/.worktrees/task-5-recovering-payloads | e17984039d (fast-forward integrated from lane) | `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/unit_tests/flux/api/test_payloads.py tests/unit_tests/examples/strategies/test_equities_readiness.py tests/unit_tests/flux/api/test_equities_profile_contract.py -k 'recovering or down or quote_health'` initial import failure in fresh lane (`ModuleNotFoundError: nautilus_trader.core.data` before test collection); same command after syncing ignored compiled lane artifacts red (`6 failed, 4 passed, 148 deselected`) then green (`10 passed, 148 deselected in 0.46s`); fix-loop red `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q /home/ubuntu/nautilus_trader/.worktrees/task-5-recovering-payloads/tests/unit_tests/flux/api/test_payloads.py /home/ubuntu/nautilus_trader/.worktrees/task-5-recovering-payloads/tests/unit_tests/flux/api/test_equities_profile_contract.py -k 'fail_closes_internal_recovery_quote_health_states'` (`4 failed`); fix-loop green same command (`4 passed, 130 deselected`); latest targeted green `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q /home/ubuntu/nautilus_trader/.worktrees/task-5-recovering-payloads/tests/unit_tests/flux/api/test_payloads.py /home/ubuntu/nautilus_trader/.worktrees/task-5-recovering-payloads/tests/unit_tests/flux/api/test_equities_profile_contract.py -k 'fail_closes_internal_recovery_quote_health_states or preserves_partial_explicit_ibkr_feed_state'` (`5 passed, 129 deselected in 0.43s`); latest required suite green same command above (`10 passed, 148 deselected in 0.50s`); `git diff --check` PASS | 2026-03-28: Fast-forward integrated Task 5 at e17984039d after fresh spec re-review returned no findings and the final quality review returned no findings. Residual risk is narrow: the review was diff-only, so any out-of-diff consumer that implicitly relied on the previous raw-state leg values would need separate validation. |
| Task 6: Validate Live Recovery And Cut The V1 Prod Release | completed | controller | Task 1, Task 2, Task 3, Task 4, Task 5 | docs/plans/2026-03-27-equities-shared-symbol-node.md; docs/runbooks/equities-shared-node-cutover.md; ops/scripts/deploy/check_equities_live_readiness.sh | lanes/task-6-rollout-validation | /home/ubuntu/nautilus_trader/.worktrees/task-6-rollout-validation | c27dbd61c6 (fast-forward integrated from lane) | `cargo test -p nautilus-hyperliquid --test http recovery -- --nocapture` PASS (`1 passed`); `cargo test -p nautilus-hyperliquid --test websocket recovery -- --nocapture` PASS (`5 passed`); `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_quote_feed_supervisor.py` PASS (`17 passed`); `./.venv.py312/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/flux/strategies/equities_maker/test_strategy.py` PASS (`16 passed`); `./.venv.py312/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/flux/strategies/equities_taker/test_strategy.py` PASS (`12 passed`); `./.venv.py312/bin/python -m pytest -q tests/integration_tests/adapters/hyperliquid/test_data.py -k 'recovery or cache or subscribe_quotes'` PASS (`1 passed, 18 deselected`); `./.venv.py312/bin/python -m pytest -q tests/unit_tests/adapters/binance/test_data_recovery.py` PASS (`16 passed`); `./.venv.py312/bin/python -m pytest -q tests/unit_tests/flux/api/test_payloads.py tests/unit_tests/examples/strategies/test_equities_readiness.py tests/unit_tests/flux/api/test_equities_profile_contract.py` PASS (`158 passed`); `bash -n ops/scripts/deploy/check_equities_live_readiness.sh` PASS; `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_api.py -k 'readiness_route or attach_equities_readiness_route or equities_run_api_main_registers_readiness_route'` PASS (`2 passed, 23 deselected`); `/home/ubuntu/nautilus_trader/.worktrees/equities-market-data-recovery-v1-impl-20260328/.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_readiness.py tests/unit_tests/flux/api/test_equities_profile_contract.py tests/unit_tests/flux/api/test_payloads.py -k 'feed_state or recovering or bootstrapping or readiness'` PASS twice (`29 passed, 129 deselected` before `c27dbd61c6`; `29 passed, 129 deselected` after `c27dbd61c6`); lane `git diff --check` PASS before `c37ad1957b`; lane `git diff --check` PASS before `6e0c6a0ac3`; lane `git diff --check` PASS before `1a61f2fd1b`; lane `git diff --check` PASS before `c27dbd61c6`; latest lane `git diff --check` PASS after `c27dbd61c6` | 2026-03-28: Fast-forward integrated Task 6 at `c27dbd61c6` after Spec Reviewer the 43rd returned `No Task 6 spec findings.` on `c37ad1957b..6e0c6a0ac3` and Quality Reviewer the 45th returned `No Task 6 quality findings.` on `1a61f2fd1b..c27dbd61c6`. The docs now frame V1 explicitly as an intra-node recovery wave, keep IBKR plus `chainsaw@md-ibkr-publisher.service` as rollout preconditions, require a bounded 15-minute soak, align signoff states with the actual equities readiness gate, and preserve the host-local projection-scope override in the wrapper fallback. Residual risk is operational rather than code-level: the stricter live acceptance criteria still need to be exercised on the host during an actual cutover before declaring prod ready. |
