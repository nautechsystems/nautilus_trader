...
21. 2026-03-04T10:30:50Z | Ops - Managed live stack launcher | SHAs: `12398dcd4` | Notes: Added `scripts/deploy/makerv3_stack.sh` plus live-mode config/env examples under `examples/live/makerv3/config/` to run node/bridge/api together with explicit safety gating.
