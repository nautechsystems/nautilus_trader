...
22. 2026-03-04T11:44:12Z | Cleanup - Remove legacy prototype artifacts and scrub docs | SHAs: `389835b51` | Notes: Deleted deprecated `examples/live/poc/*` entrypoints, renamed the archived plan doc from `*-poc.md` to `*-prototype.md`, removed legacy key mapping strings from `docs/flux/redis_schema.md`, and simplified `scripts/ci/check-flux-leakage.sh` to scan durable docs directly.
