...
| --- | --- | --- | --- |
| Overall | in_progress | codex | Task 1 started; adding fail-first Signal/API contract tests |
| Task 1: Freeze Signal source-of-truth contract | in_progress | codex | Writing fail-first tests for maker quote snapshot vs spread/skew source-of-truth |
| Task 2: Publish coherent MakerV3 quote snapshot | not_started | unassigned | Plan created |
| Task 3: Make Signal render from one pricing truth | not_started | unassigned | Plan created |
