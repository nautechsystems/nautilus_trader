...
| --- | --- | --- | --- |
| Overall | in_progress | main | Tasks 1-2 are completed on branch head, including the Task 2 doc/test drift follow-up from quality review; Task 3 is in progress to wire shared account providers from `account_scopes` into the equities portfolio runner. |
