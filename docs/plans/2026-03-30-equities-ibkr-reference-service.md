...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | in_progress | main | Task 1-5 | `docs/plans/2026-03-30-equities-ibkr-reference-service.md` | `shared` | `shared` | none | not_run | 2026-03-30: Controller started serial SDD execution on `fix/equities-market-data-recovery-v1-impl-20260328`; #91 is now the single integration PR against `main` and #88/#90 are closed as absorbed |
