...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | completed | main | Task 1-5 | `docs/plans/2026-03-30-equities-ibkr-reference-service.md` | `shared` | `shared` | `e44ec3609d`, `5f3c0aa86c`, `f04ca27261`, `b18c18aaeb`, `b68e772c24`, final tracker closeout diff | Task 1-5 targeted verification PASS; `git diff --check` PASS | 2026-03-30: Serial SDD execution completed on `fix/equities-market-data-recovery-v1-impl-20260328`; fork PR `#91` is the single open draft integration PR against `main`, and `#88` / `#90` remain closed as absorbed |
| Task 1: Add Shared IBKR Reference Config And Redis Key Contract | completed | main | none | `systems/flux/flux/common/keys.py`, `deploy/equities/equities.live.toml`, `tests/unit_tests/flux/common/test_keys.py`, `tests/unit_tests/flux/api/test_equities_profile_contract.py`, `tests/unit_tests/flux/strategies/shared/test_equities_arb_core.py` | `shared` | `shared` | `e44ec3609d` | `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/flux/common/test_keys.py -k 'profile_market or market_data_status'` PASS (`2 passed, 15 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/flux/api/test_equities_profile_contract.py -k 'reference or account_scope or strategy_contract'` PASS (`10 passed, 41 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/flux/strategies/shared/test_equities_arb_core.py -k 'effective_venue_resolution'` PASS (`1 passed, 7 deselected`); `git diff --check -- deploy/equities/equities.live.toml systems/flux/flux/common/keys.py tests/unit_tests/flux/api/test_equities_profile_contract.py tests/unit_tests/flux/common/test_keys.py` PASS | 2026-03-30: Spec Reviewer returned `No Task 1 spec findings.` and Quality Reviewer returned `No Task 1 quality findings.` for commit `e44ec3609d` |
| Task 2: Implement The Flux-Owned IBKR Reference Publisher Runner | completed | main | Task 1 | `systems/flux/flux/runners/shared/ibkr_reference_publisher.py`, `systems/flux/flux/runners/equities/run_ibkr_reference_publisher.py`, `tests/unit_tests/examples/strategies/test_equities_ibkr_reference_publisher.py`, `tests/unit_tests/examples/strategies/test_equities_run_portfolio.py` | `shared` | `shared` | `5f3c0aa86c` | `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_ibkr_reference_publisher.py` PASS (`8 passed`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/examples/strategies/test_equities_run_portfolio.py -k 'account_scope or strategy_contracts or equities or ibkr_reference'` PASS (`24 passed`); `git diff --check -- systems/flux/flux/runners/shared/ibkr_reference_publisher.py systems/flux/flux/runners/equities/run_ibkr_reference_publisher.py tests/unit_tests/examples/strategies/test_equities_ibkr_reference_publisher.py tests/unit_tests/examples/strategies/test_equities_run_portfolio.py` PASS | 2026-03-30: Fresh implementer handoff stalled without touching the write scope, so controller resumed Task 2 locally; follow-up fix `5f3c0aa86c` ensures runtime shutdown awaits client stop before loop shutdown. Review subagent lanes stalled repeatedly, but fresh spec reviewer `Bernoulli` later returned `No Task 2 spec findings.`; controller’s final quality audit found no remaining Task 2 findings |
| Task 3: Add The Shared-Reference IBKR Market-Data Adapter And Wire Equities Nodes To It | completed | main | Task 1, Task 2 | `nautilus_trader/adapters/interactive_brokers/shared_reference/config.py`, `nautilus_trader/adapters/interactive_brokers/shared_reference/data.py`, `nautilus_trader/adapters/interactive_brokers/shared_reference/factories.py`, `nautilus_trader/adapters/interactive_brokers/__init__.py`, `systems/flux/flux/runners/live/venues.py`, `systems/flux/flux/strategies/shared/equities_arb/core.py`, `systems/flux/flux/runners/equities/run_node.py`, `tests/unit_tests/examples/strategies/test_equities_run_node.py`, `tests/unit_tests/flux/strategies/shared/test_equities_arb_core.py`, `tests/unit_tests/adapters/interactive_brokers/test_shared_reference_data.py` | `shared` | `shared` | `f04ca27261` | `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/adapters/interactive_brokers/test_shared_reference_data.py` PASS (`2 passed`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/flux/strategies/shared/test_equities_arb_core.py -k 'effective_venue_resolution'` PASS (`1 passed, 7 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/examples/strategies/test_equities_run_node.py -k 'ibkr or shared_reference or venue_resolution'` PASS (`7 passed, 56 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_live_venue_registry.py` PASS (`20 passed`) | 2026-03-30: Added Flux-owned shared-reference adapter package and split IBKR venue resolution into `data_adapter`/`exec_adapter`; equities immediate-hedge rewrite now preserves IBKR execution while routing quote delivery through the shared-reference feed |
| Task 4: Update Readiness, Deploy, And Operator Surfaces To Use The Flux-Owned Publisher | completed | main | Task 2, Task 3 | `systems/flux/flux/runners/equities/readiness.py`, `systems/flux/flux/runners/equities/run_api.py`, `tests/unit_tests/examples/strategies/test_equities_readiness.py`, `tests/unit_tests/examples/strategies/test_equities_run_api.py`, `ops/scripts/deploy/install_equities_systemd.sh`, `tests/unit_tests/ops/deploy/test_install_equities_systemd.py`, `ops/scripts/deploy/check_equities_live_readiness.sh`, `deploy/equities/README.md`, `docs/runbooks/equities-shared-node-cutover.md` | `shared` | `shared` | `b18c18aaeb` | `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_readiness.py -k 'ibkr_reference_publisher_status or wrapper_and_runbook_document_the_host_local_gate'` FAIL (`TypeError: unexpected keyword argument publisher_status_payload`; doc assertion missing `flux@equities-ibkr-reference-publisher.service`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/ops/deploy/test_install_equities_systemd.py -k 'flux_owned_ibkr_reference_publisher_service'` FAIL (`render_publisher_env: command not found`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_readiness.py -k 'ibkr or readiness or reference'` PASS (`27 passed`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_api.py -k 'readiness'` PASS (`3 passed, 23 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/ops/deploy/test_install_equities_systemd.py -k 'publisher or equities'` PASS (`11 passed`); `bash -n ops/scripts/deploy/install_equities_systemd.sh` PASS; `git diff --check -- systems/flux/flux/runners/equities/readiness.py systems/flux/flux/runners/equities/run_api.py tests/unit_tests/examples/strategies/test_equities_readiness.py tests/unit_tests/examples/strategies/test_equities_run_api.py ops/scripts/deploy/install_equities_systemd.sh tests/unit_tests/ops/deploy/test_install_equities_systemd.py deploy/equities/README.md docs/runbooks/equities-shared-node-cutover.md docs/plans/2026-03-30-equities-ibkr-reference-service.md` PASS | 2026-03-30: Task 4 shipped in `b18c18aaeb`; fresh post-fix spec review returned `No Task 4 spec findings.` and fresh post-fix quality review returned `No Task 4 quality findings.` after the `/api/v1/readiness?profile=equities` cutover fix |
| Task 5: Run End-To-End Verification And Clean Up The Consolidated Equities Integration Branch | completed | main | Task 1, Task 2, Task 3, Task 4 | `docs/plans/2026-03-30-equities-ibkr-reference-service.md`, git branch/PR metadata, touched code from Tasks 1-4 only as needed for fixes | `shared` | `shared` | final tracker closeout diff | `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_ibkr_reference_publisher.py tests/unit_tests/adapters/interactive_brokers/test_shared_reference_data.py` PASS (`10 passed`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_node.py tests/unit_tests/examples/strategies/test_equities_readiness.py -k 'ibkr or shared_reference or readiness'` PASS (`33 passed, 57 deselected`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q --import-mode=importlib tests/unit_tests/examples/strategies/test_equities_run_portfolio.py` PASS (`24 passed`); `/home/ubuntu/nautilus_trader/.venv/bin/python -m pytest -q tests/unit_tests/flux/api/test_equities_profile_contract.py` PASS (`51 passed`); `git diff --check` PASS | 2026-03-30: Full Task 5 targeted verification passed on the consolidated branch using `/home/ubuntu/nautilus_trader/.venv/bin/python` because `.venv.py312` is not present in this repo/worktree; implementer lane reported no new code risks; fresh Task 5 spec review returned `No Task 5 spec findings.` and fresh Task 5 quality review returned `No Task 5 quality findings.`. Fork PR metadata confirmed the single integration PR is open draft `#91` (`fix(equities): consolidate market-data recovery and ibkr reference rehome`) against `main`, while `#88` and `#90` are closed |
...
- Test: `tests/unit_tests/ops/deploy/test_install_equities_systemd.py`
...
**Write Scope:** `systems/flux/flux/runners/equities/readiness.py`, `systems/flux/flux/runners/equities/run_api.py`, `tests/unit_tests/examples/strategies/test_equities_readiness.py`, `tests/unit_tests/examples/strategies/test_equities_run_api.py`, `ops/scripts/deploy/install_equities_systemd.sh`, `tests/unit_tests/ops/deploy/test_install_equities_systemd.py`, `ops/scripts/deploy/check_equities_live_readiness.sh`, `deploy/equities/README.md`, `docs/runbooks/equities-shared-node-cutover.md`
...
- `./.venv.py312/bin/python -m pytest -q tests/unit_tests/examples/strategies/test_equities_run_api.py -k 'readiness'`
- `./.venv.py312/bin/python -m pytest -q tests/unit_tests/ops/deploy/test_install_equities_systemd.py -k 'publisher or equities'`
