...
| Task 3: `OrderActionPersistenceActor` | DONE | Added orders actor/config with selected event filtering, enqueue-only hot path, bounded batch flush, threaded durability barrier semantics, and strict/non-strict backlog shutdown tests. Refs: `241adae5f` | `241adae5f` |
