...
| Task 4: Docs update | DONE | Added execution docs for `OrderActionPersistenceActor` usage, topic patterns, Redis wildcard caveat, and example SQL queries including `action_state` and fills joins. Refs: `054f1e652`, `6a6aeeef0`, `3689f3130`, `204bff39d`. | `054f1e652`, `6a6aeeef0`, `3689f3130`, `204bff39d` |
