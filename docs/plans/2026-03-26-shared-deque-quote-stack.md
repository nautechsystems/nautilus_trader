...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Overall | in_progress | controller | none | `systems/flux/flux/strategies/shared`, `systems/flux/flux/strategies/makerv3`, `nautilus_trader/persistence/orders`, `tests/unit_tests/flux/strategies/shared`, `tests/unit_tests/flux/strategies/makerv3`, `tests/unit_tests/persistence`, `systems/flux/docs`, `docs/runbooks`, `research/tokenmm`, `docs/plans` | `codex/shared-deque-quote-stack` | `.worktrees/shared-deque-quote-stack` | Tasks 1-5 satisfied; Task 6 starting | Task 5 verified green; docs work opening | Controller worktree ready; uv environment synced; strategy-side deque telemetry is landed and verified, persistence ancestry is confirmed, and the next step is operator-facing docs + audit helper updates |
...
| Task 6: Update docs and operator audit surfaces | in_progress | main | Task 5: Complete quote-action telemetry in quote-cycle and order_action | `systems/flux/docs/makerv3.md`, `docs/runbooks/tokenmm-makerv3-bounded-convergence-rollout.md`, `research/tokenmm/telemetry_helpers.py`, `research/tokenmm/README.md`, `tests/unit_tests/docs`, `docs/plans/2026-03-26-shared-deque-quote-stack-design.md`, `docs/plans/2026-03-26-shared-deque-quote-stack.md` | `codex/shared-deque-quote-stack` | `.worktrees/shared-deque-quote-stack` | none | not_run | Reading docs surfaces now; next change is to document front/back-only repricing, no resting-order TTL refresh, new quote-cycle/order_action audit fields, and SQLite audit helpers |
| Task 7: Run targeted verification and capture rollout-ready evidence | not_started | main | Task 6: Update docs and operator audit surfaces | `tests/unit_tests/flux/strategies/shared/test_quote_stack.py`, `tests/unit_tests/flux/strategies/makerv3`, `tests/unit_tests/persistence`, `tests/unit_tests/docs`, `docs/plans/2026-03-26-shared-deque-quote-stack.md` | `shared` | `shared` | none | not_run | Plan created |
