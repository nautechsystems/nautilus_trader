...
| Task 4: Canonicalize the shared-host dev repo and worktree layout | completed | main | Task 1 | `/home/ubuntu/nautilus_trader`, `/home/ubuntu/nautilus-trader-dev`, `/home/ubuntu/nautilus_trader_prod`, `/home/ubuntu/.config/superpowers/worktrees/nautilus_trader`, `/home/ubuntu/.worktrees/nautilus_trader`, `docs/runbooks/deploy-lanes.md` | `codex/prod-lanes-exec-20260326` | `/home/ubuntu/nautilus_trader/.worktrees/prod-lanes-exec-20260326` | pending | `git -C /home/ubuntu/nautilus_trader worktree list PASS; find /home/ubuntu ... PASS; du -sh /home/ubuntu/nautilus_trader /home/ubuntu/nautilus-trader-dev /home/ubuntu/nautilus_trader_prod PASS` | Moved the five external registered worktrees into `~/nautilus_trader/.worktrees` and archived extra top-level Nautilus clones under `~/backups/nautilus/archived-host-layout-20260326/` |
| Task 5: Repoint current prod lanes to immutable release roots | in_progress | main | Task 2, Task 3, Task 4 | `/etc/flux/tokenmm*.env`, `/etc/flux/equities*.env`, `~/releases/prod/tokenmm`, `~/releases/prod/equities`, `deploy/tokenmm/README.md`, `deploy/equities/README.md` | `codex/prod-lanes-exec-20260326` | `/home/ubuntu/nautilus_trader/.worktrees/prod-lanes-exec-20260326` | none | not_run | Starting host verification and release-root materialization after canonical host cleanup |
