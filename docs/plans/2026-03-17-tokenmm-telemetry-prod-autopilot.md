...
| --- | --- | --- | --- |
| Overall | in_progress | main | Execution started in isolated worktree `codex/tokenmm-telemetry-prod-ops-20260317`; deploying later from stable root after verification |
| Task 1: Lock The Managed Telemetry Contract In Tests | in_progress | main | Writing failing contract tests for managed RDS bootstrap, shipper wrapper, and bounded local retention |
| Task 2: Add AWS Bootstrap Automation For The Telemetry Sink | in_progress | main | Bootstrap script, env template, and docs landed; pending targeted verification |
| Task 3: Auto-Load Postgres Credentials And Harden Shipper Startup | in_progress | main | Wrapper, installer wiring, and startup exit-78 path landed; pending targeted verification |
| Task 4: Bound Local Telemetry Retention And Add Health Guardrails | in_progress | main | 48h retention, healthcheck, timer, and cutover helper landed; pending targeted verification |
| Task 5: Execute The Production Backfill And Disk-Reclaim Cutover | not_started | main | Plan created |
| Task 6: Update Runbooks, Verify End-To-End, And Open The PR | not_started | main | Plan created |
