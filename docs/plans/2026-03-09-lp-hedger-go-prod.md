...
| Task 5: Harden LP Systemd And Shared-Host Env Contracts | in_progress | main | Starting the red contract checks for shared-host env defaults, Band1/Band2-only enrollment, and explicit restart-order/install guidance in the LP systemd installer flow. |
