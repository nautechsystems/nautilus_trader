...
| Task 4: Add LP Preflight Audit Tooling For Shared-Host Production | in_progress | main | Starting the red preflight tests for loopback `LP_API_BACKEND_URL`, required `lp-system.ini` sections, and Band1/Band2 config readability. |
