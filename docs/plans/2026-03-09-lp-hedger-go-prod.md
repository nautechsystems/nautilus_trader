...
| Task 6: Add Rollout Health Checks, Canary Procedure, And Rollback Evidence | in_progress | main | Starting the rollout-check and review-template red tests for `/lp`, the LP hedger API, Pulse, and the final go/no-go plus rollback evidence path. |
