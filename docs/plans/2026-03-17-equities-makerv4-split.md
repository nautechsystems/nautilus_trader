...
| Task 1: Lock Split Contract In Docs And Execution Matrix | not_started | unassigned | none | `docs/plans/2026-03-17-equities-makerv4-split-design.md`, `deploy/equities/README.md`, `deploy/equities/strategies/README.md`, `fluxboard/docs/equities_contract.md`, `docs/plans/2026-03-17-equities-makerv4-split.md` | `shared` | `shared` | none | not_run | Plan created |
