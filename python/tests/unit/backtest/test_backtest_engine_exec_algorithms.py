...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("subscribe_queue_state", ["self", "channel", "priority"]),
        ("subscribe_socket_state", ["self", "client_id", "endpoint", "priority"]),
        ("unsubscribe_signal", ["self", "name"]),
        ("unsubscribe_queue_state", ["self", "channel"]),
        ("unsubscribe_socket_state", ["self", "client_id", "endpoint"]),
