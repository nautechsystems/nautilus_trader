...
@typing.final
class BinaryOptionScope:
    def __init__(self, scope_id: str, venue: Venue) -> None: ...
    @property
...
@typing.final
class BinaryOptionScopeSlice:
    @property
    def scope_id(self) -> str: ...
    @property
    def venue(self) -> Venue: ...
    @property
    def members(self) -> list[BinaryOptionScopeMember]: ...
    @property
...
@typing.final
class BinaryOptionScopeStreams:
    def __init__(
        self, quotes: bool = False, trades: bool = False, book_deltas: bool = False
    ) -> None: ...
