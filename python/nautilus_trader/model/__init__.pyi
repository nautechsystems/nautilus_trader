...
class FixedTickScheme:
    ...
    def __new__(
        cls, name: str, price_precision: int, increment: float | None = None
    ) -> FixedTickScheme: ...
...
class TieredTickScheme:
    ...
    @property
    def ticks(self) -> list[Price]: ...
    @property
    def tick_count(self) -> int: ...
    def __new__(
        cls,
        name: str,
        tiers: typing.Sequence[tuple[float, float, float]],
        price_precision: int,
...
def get_tick_scheme(name: str) -> typing.Any: ...
...
def register_tick_scheme(tick_scheme: typing.Any) -> None: ...
