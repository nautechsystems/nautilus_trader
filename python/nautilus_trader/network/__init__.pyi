...
class SocketConfig:
    ...
    @property
    def heartbeat(self) -> tuple[int, bytes] | None: ...
    @property
    def reconnect_timeout_ms(self) -> int | None: ...
    @property
    def reconnect_delay_initial_ms(self) -> int | None: ...
    @property
    def reconnect_delay_max_ms(self) -> int | None: ...
    @property
    def reconnect_backoff_factor(self) -> float | None: ...
    @property
    def reconnect_jitter_ms(self) -> int | None: ...
    @property
    def connection_max_retries(self) -> int | None: ...
    @property
    def reconnect_max_attempts(self) -> int | None: ...
    @property
