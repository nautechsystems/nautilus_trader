...
class Cache:
    ...
    def top_of_book(
        self, instrument_id: model.InstrumentId
    ) -> tuple[model.Price, model.Quantity, model.Price, model.Quantity] | None: ...
    ...
    def account_for_client(self, client_id: model.ClientId) -> typing.Any | None: ...
    def account_id_for_client(self, client_id: model.ClientId) -> model.AccountId | None: ...
