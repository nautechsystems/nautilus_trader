...
class InteractiveBrokersDataClientConfig:
    def __init__(
        ...
        subscription_idle_timeout_secs: int | None = None,
    ) -> None: ...
    @property
    def host(self) -> str: ...
    @property
    ...
    @property
    def subscription_idle_timeout_secs(self) -> int | None: ...
    @property
...
@typing.final
class InteractiveBrokersSubscriptionIdle:
    @property
    ...
    @property
    def idle_timeout_secs(self) -> int: ...
    @property
    def last_data_received_ns(self) -> typing.Any: ...
    @property
    ...
    def __new__(
        ...
        last_data_received_ns: typing.Any,
        ts_event: int,
        ts_init: int,
    ) -> InteractiveBrokersSubscriptionIdle: ...
