...
class HyperliquidWebSocketClient:
    ...
    def subscribe_book(self, instrument_id: model.InstrumentId, fast: bool = ...) -> typing.Any: ...
    def unsubscribe_book(self, instrument_id: model.InstrumentId) -> typing.Any: ...
    def subscribe_book_deltas(
        self, instrument_id: model.InstrumentId, _book_type: int, _depth: int, fast: bool = ...
    ) -> typing.Any: ...
