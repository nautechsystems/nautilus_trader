...
class Strategy:
    ...
    def on_binary_option_scope(self, slice: model.BinaryOptionScopeSlice) -> None: ...
    ...
    def subscribe_binary_option_scope(
        self,
        scope: model.BinaryOptionScope,
        streams: model.BinaryOptionScopeStreams | None = None,
        client_id: model.ClientId | None = None,
        params: dict | None = None,
    ) -> None: ...
    ...
    def unsubscribe_binary_option_scope(
        self, scope: model.BinaryOptionScope, client_id: model.ClientId | None = None
    ) -> None: ...
