...
class Strategy:
    ...
    def query_account(
        self, account_id: model.AccountId, client_id: model.ClientId | None = None
    ) -> None: ...
    def query_order(self, order: typing.Any, client_id: model.ClientId | None = None) -> None: ...
    ...
    def on_historical_data(self, data: model.CustomData) -> None: ...
