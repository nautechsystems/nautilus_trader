  ...
  useEffect(() => {
    ...
    const handleSignalDelta = (delta: any) => {
      try {
        ...
        if (!visibleByProfile && !knownInView) {
          return;
        }
  ...
  const content = (
    <>
        ...
        <PanelHeader
          ...
          titleActions={
            <SimpleTooltip
              ...
              content={
                wsConnected
                  ? 'Live via WebSocket. Polling pauses while updates are fresh.'
                  : 'Polling fallback active. WebSocket is disconnected or stale.'
              }
            >
      ...
      <PanelBody ref={handleVisibilityRootRef}>
        {shouldUseEquitiesArbTable ? (
          <EquitiesArbSignalTable rows={filteredRows} loading={loading} />
