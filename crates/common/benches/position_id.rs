...
use nautilus_common::{clock::VirtualClock, generators::position_id::PositionIdGenerator};
use nautilus_core::UnixNanos;
use nautilus_model::identifiers::{StrategyId, TraderId};

const SECOND_NS: u64 = 1_000_000_000;

fn make_generator(clock: Rc<RefCell<VirtualClock>>) -> PositionIdGenerator {
...
fn bench_same_second_one_strategy(c: &mut Criterion) {
    ...
    c.bench_function("position_id/same_second_one_strategy", |b| {
        let mut generator = make_generator(Rc::new(RefCell::new(VirtualClock::new())));
