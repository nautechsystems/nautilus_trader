...
use nautilus_common::{clock::VirtualClock, generators::order_list_id::OrderListIdGenerator};
use nautilus_core::UnixNanos;
use nautilus_model::identifiers::{StrategyId, TraderId};

const SECOND_NS: u64 = 1_000_000_000;

fn make_generator(clock: Rc<RefCell<VirtualClock>>) -> OrderListIdGenerator {
