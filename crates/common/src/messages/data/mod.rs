...
pub use subscribe::{
    RefreshBookSubscription, SubscribeBars, SubscribeBookDeltas, SubscribeBookDepth10,
...
pub enum SubscribeCommand {
    ...
    BookRefresh(RefreshBookSubscription),
...
impl SubscribeCommand {
    ...
    pub fn command_id(&self) -> UUID4 {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.command_id,
    ...
    pub fn client_id(&self) -> Option<&ClientId> {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.client_id.as_ref(),
    ...
    pub fn venue(&self) -> Option<&Venue> {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.venue.as_ref(),
    ...
    pub fn ts_init(&self) -> UnixNanos {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.ts_init,
    ...
    pub fn correlation_id(&self) -> Option<UUID4> {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.correlation_id,
    ...
    pub fn params(&self) -> Option<&Params> {
        match self {
            ...
            Self::BookRefresh(cmd) => cmd.params.as_ref(),
