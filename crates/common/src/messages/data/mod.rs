...
pub use unsubscribe::{
    ...
    UnsubscribeBorrowRates, UnsubscribeCustomData, UnsubscribeFundingRates, UnsubscribeIndexPrices,
...
pub enum SubscribeCommand {
    ...
    BorrowRates(SubscribeBorrowRates),
...
impl SubscribeCommand {
    ...
    pub fn command_id(&self) -> UUID4 {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.command_id,
    ...
    pub fn client_id(&self) -> Option<&ClientId> {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.client_id.as_ref(),
    ...
    pub fn venue(&self) -> Option<&Venue> {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.venue.as_ref(),
    ...
    pub fn ts_init(&self) -> UnixNanos {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.ts_init,
    ...
    pub fn correlation_id(&self) -> Option<UUID4> {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.correlation_id,
    ...
    pub fn params(&self) -> Option<&Params> {
        match self {
            ...
            Self::BorrowRates(cmd) => cmd.params.as_ref(),
...
pub enum UnsubscribeCommand {
    ...
    BorrowRates(UnsubscribeBorrowRates),
