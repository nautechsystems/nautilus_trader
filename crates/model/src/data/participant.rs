...
use crate::{
    ...
    types::{AccountBalance, Money, Price},
};
...
impl Participant {
    ...
    pub fn new(
        ...
        Self::new_checked(id, venue, kind, first_seen_at, last_seen_at, ts_init).expect_display(FAILED)
    }
}
...
pub struct ParticipantProfile {
    ...
    /// A bounded window of recent fills or trades, or `None` when unavailable.
    pub recent_trades: Option<Vec<FillReport>>,
...
impl ParticipantProfile {
    ...
    pub fn new(
        ...
        recent_trades: Option<Vec<FillReport>>,
...
mod tests {
    ...
    fn test_participant_profile_tracks_available_data() {
        let transaction = ParticipantTransaction::new(
            ...
            UnixNanos::from(2),
            ParticipantId::new(PARTICIPANT_ID),
            ParticipantId::new("0xabcdefabcdefabcdefabcdefabcdefabcdefabcd"),
            dec!(0.575),
