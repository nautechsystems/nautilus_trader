...
use crate::{
    data::{
        Participant, ParticipantKind, ParticipantProfile, ParticipantTransaction, TransactionMethod,
    },
...
impl ParticipantTransaction {
    ...
    #[getter]
    const fn from_id(&self) -> ParticipantId {
        self.from
    }

    #[getter]
    const fn to_id(&self) -> ParticipantId {
        self.to
    }
...
impl ParticipantProfile {
    ...
    #[getter]
    fn recent_trades(&self) -> Option<Vec<FillReport>> {
