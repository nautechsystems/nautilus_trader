...
mod tests {
    ...
    #[test]
    fn test_trailing_stop_limit_order_creation() {
        // Create a trailing stop limit order with specific parameters
        ...
        // Assert that the trailing stop limit specific fields are correctly set
        ...
        assert_eq!(order.limit_offset(), Some(dec!(2.0)));
        assert_eq!(order.trailing_offset(), Some(dec!(1.0)));
        assert_eq!(
    ...
    #[test]
    fn test_trailing_stop_limit_order_expire_time() {
        // Create a new TrailingStopLimitOrder with an expire time
