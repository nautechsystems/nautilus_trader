...
impl ArrowSchemaProvider for OptionSpread {
    fn get_schema(metadata: Option<HashMap<String, String>>) -> Schema {
        ...
        final_metadata.insert(KEY_CLASS.to_string(), "OptionSpread".to_string());
...
impl EncodeToRecordBatch for OptionSpread {
        ...
        T: std::borrow::Borrow<Self>,
    {
        ...
        for os in data.iter().map(Borrow::borrow) {
            ...
            if let Some(tick_scheme) = os.tick_scheme {
...
/// Decodes [`OptionSpread`] instruments from a record batch.
///
...
pub fn decode_option_spread_batch(
    ...
    for i in 0..num_rows {
        ...
        let option_spread = OptionSpread::builder()
            .instrument_id(id)
            ...
            .ts_init(ts_init)
            .build()
            .map_err(|e| super::instrument_validation_error::<OptionSpread>(i, e))?;
