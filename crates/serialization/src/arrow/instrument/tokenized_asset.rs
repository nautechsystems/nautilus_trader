...
impl EncodeToRecordBatch for TokenizedAsset {
        ...
        T: std::borrow::Borrow<Self>,
    {
        ...
        for ta in data.iter().map(Borrow::borrow) {
            ...
            if let Some(tick_scheme) = ta.tick_scheme {
...
pub fn decode_tokenized_asset_batch(
    ...
    let info_values =
        extract_column_by_name_or_index::<StringArray>(record_batch, "info", 22, DataType::Utf8)?;
    ...
    for i in 0..num_rows {
        ...
        let tokenized_asset = TokenizedAsset::builder()
            .instrument_id(id)
            ...
            .ts_init(ts_init)
            .build()
            .map_err(|e| super::instrument_validation_error::<TokenizedAsset>(i, e))?;
