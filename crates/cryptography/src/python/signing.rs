...
/// # Errors
///
/// Returns a `PyErr` if signature generation fails, e.g., due to empty data or invalid key PEM.
...
/// # Errors
///
/// Returns a `PyErr` if the private key seed is invalid or signature creation fails.
