pub use decoder::VarString8Decoder;
pub use encoder::VarString8Encoder;
...
pub mod encoder {
    ...
    pub struct VarString8Encoder<P> {
        parent: Option<P>,
        offset: usize,
    }
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct VarString8Decoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> ActingVersion for VarString8Decoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for VarString8Decoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
