pub use decoder::TradesResponseDecoder;
pub use encoder::TradesResponseEncoder;
...
pub mod encoder {
    ...
    pub struct TradesResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for TradesResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> TradesResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct TradesResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for TradesResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TradesResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> TradesResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
