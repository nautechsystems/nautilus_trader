pub use decoder::MarketLotSizeFilterDecoder;
pub use encoder::MarketLotSizeFilterEncoder;
...
pub mod encoder {
    ...
    pub struct MarketLotSizeFilterEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for MarketLotSizeFilterEncoder<'a> {
        #[inline]
    ...
    impl<'a> MarketLotSizeFilterEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn min_qty(&mut self, value: i64) {
            let offset = self.offset + 1;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'maxQty'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn max_qty(&mut self, value: i64) {
            let offset = self.offset + 9;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'stepSize'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn step_size(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct MarketLotSizeFilterDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MarketLotSizeFilterDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MarketLotSizeFilterDecoder<'a> {
        #[inline]
    ...
    impl<'a> MarketLotSizeFilterDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn filter_type(&self) -> filter_type::FilterType {
            filter_type::FilterType::MarketLotSize
        }
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn min_qty(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 1)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn max_qty(&self) -> i64 {
