pub use decoder::NewOrderResultResponseDecoder;
pub use encoder::NewOrderResultResponseEncoder;
...
pub mod encoder {
    ...
    pub struct NewOrderResultResponseEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for NewOrderResultResponseEncoder<'a> {
        #[inline]
    ...
    impl<'a> NewOrderResultResponseEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct NewOrderResultResponseDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for NewOrderResultResponseDecoder<'a> {
        #[inline]
    ...
    impl<'a> NewOrderResultResponseDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
