...
impl DatabentoHistoricalClient {
    ...
    #[pyo3(name = "get_order_book_depths")]
    #[pyo3(signature = (dataset, symbols, start, end=None, depth=None))]
    #[allow(clippy::too_many_arguments)]
    fn py_get_order_book_depths<'py>(
        &self,
        py: Python<'py>,
        dataset: String,
        symbols: Vec<String>,
        ...
        pyo3_async_runtimes::tokio::future_into_py(py, async move {
            let depths = inner
                .get_range_order_book_depths(params, depth)
                .await
                .map_err(to_pyvalue_err)?;
