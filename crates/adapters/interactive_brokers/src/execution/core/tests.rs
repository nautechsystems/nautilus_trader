...
#[rstest]
#[case::pending_modify(true)]
#[case::no_pending_modify(false)]
#[tokio::test]
async fn inactive_accepted_order_stays_working(#[case] pending_modify: bool) {
    let state = SubmitTrackingState::new();
    let order_id = 7105;
...
#[case::trailing("TRAIL", None, Some(Price::from("95.00")), None, Some(1.5), Some(95.0))]
