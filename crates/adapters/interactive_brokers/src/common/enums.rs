...
mod tests {
    ...
    fn test_ib_order_type_wire_roundtrip_preserves_nautilus_order_type() {
        let order_types = [
            ...
            IbOrderType::MarketOnOpen,
            IbOrderType::LimitOnOpen,
            IbOrderType::AtAuction,
            ...
            IbOrderType::BoxTop,
            IbOrderType::AuctionLimit,
            IbOrderType::AuctionRelative,
            IbOrderType::ComboLimit,
            IbOrderType::ComboMarket,
