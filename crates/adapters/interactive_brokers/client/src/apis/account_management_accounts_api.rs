...
pub async fn gw_api_v1_accounts_account_id_details_get(
    configuration: &configuration::Configuration,
    account_id: &str,
) -> Result<models::AccountDetailsResponse, Error<GwApiV1AccountsAccountIdDetailsGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountDetailsResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountDetailsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsAccountIdDetailsGetError> =
...
pub async fn gw_api_v1_accounts_account_id_kyc_get(
    configuration: &configuration::Configuration,
    account_id: &str,
) -> Result<models::Au10TixDetailResponse, Error<GwApiV1AccountsAccountIdKycGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Au10TixDetailResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Au10TixDetailResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsAccountIdKycGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn gw_api_v1_accounts_account_id_login_messages_get(
    configuration: &configuration::Configuration,
    account_id: &str,
    r#type: Option<&str>,
) -> Result<models::LoginMessageResponse, Error<GwApiV1AccountsAccountIdLoginMessagesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    let p_type = r#type;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LoginMessageResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LoginMessageResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsAccountIdLoginMessagesGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn gw_api_v1_accounts_account_id_status_get(
    configuration: &configuration::Configuration,
    account_id: &str,
) -> Result<models::AccountStatusResponse, Error<GwApiV1AccountsAccountIdStatusGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountStatusResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountStatusResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsAccountIdStatusGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn gw_api_v1_accounts_account_id_tasks_get(
    configuration: &configuration::Configuration,
    account_id: &str,
    r#type: Option<&str>,
) -> Result<
    models::GwApiV1AccountsAccountIdTasksGet200Response,
    Error<GwApiV1AccountsAccountIdTasksGetError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    let p_type = r#type;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GwApiV1AccountsAccountIdTasksGet200Response`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GwApiV1AccountsAccountIdTasksGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsAccountIdTasksGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn gw_api_v1_accounts_close_post(
    configuration: &configuration::Configuration,
    client_id: &str,
    gw_api_v1_accounts_close_post_request: models::GwApiV1AccountsClosePostRequest,
) -> Result<models::AsynchronousInstructionResponse, Error<GwApiV1AccountsClosePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_client_id = client_id;
    let p_gw_api_v1_accounts_close_post_request = gw_api_v1_accounts_close_post_request;

    let uri_str = format!("{}/gw/api/v1/accounts/close", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);

    req_builder = req_builder.header("client-id", crate::apis::urlencode(p_client_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AsynchronousInstructionResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AsynchronousInstructionResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn gw_api_v1_accounts_documents_post(
    configuration: &configuration::Configuration,
    process_documents_payload: models::ProcessDocumentsPayload,
) -> Result<models::StatusResponse, Error<GwApiV1AccountsDocumentsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn gw_api_v1_accounts_get(
    configuration: &configuration::Configuration,
    account_id: Option<&str>,
    external_id: Option<&str>,
) -> Result<models::GwApiV1AccountsGet200Response, Error<GwApiV1AccountsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GwApiV1AccountsGet200Response`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GwApiV1AccountsGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn gw_api_v1_accounts_login_messages_get(
    configuration: &configuration::Configuration,
    login_message_request: models::LoginMessageRequest,
) -> Result<models::LoginMessageResponse, Error<GwApiV1AccountsLoginMessagesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Ok(json_str) = serde_json::to_string(&p_login_message_request) {
        req_builder = req_builder.query(&[("loginMessageRequest", &json_str)]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GwApiV1AccountsLoginMessagesGetError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn gw_api_v1_accounts_patch(
    configuration: &configuration::Configuration,
    account_management_requests_payload: models::AccountManagementRequestsPayload,
) -> Result<models::StatusResponse, Error<GwApiV1AccountsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn gw_api_v1_accounts_post(
    configuration: &configuration::Configuration,
    application_payload: models::ApplicationPayload,
) -> Result<models::StatusResponse, Error<GwApiV1AccountsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn gw_api_v1_accounts_status_get(
    configuration: &configuration::Configuration,
    account_status_request: models::AccountStatusRequest,
) -> Result<models::AccountStatusBulkResponse, Error<GwApiV1AccountsStatusGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Ok(json_str) = serde_json::to_string(&p_account_status_request) {
        req_builder = req_builder.query(&[("accountStatusRequest", &json_str)]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccountStatusBulkResponse`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccountStatusBulkResponse`")))),
        }
    } else {
        let content = resp.text().await?;
