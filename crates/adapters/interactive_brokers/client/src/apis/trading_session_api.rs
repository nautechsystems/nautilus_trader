...
pub async fn iserver_auth_ssodh_init_post(configuration: &configuration::Configuration, brokerage_session_init_request: models::BrokerageSessionInitRequest) -> Result<models::BrokerageSessionStatus, Error<IserverAuthSsodhInitPostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BrokerageSessionStatus`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BrokerageSessionStatus`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_reauthenticate_get(configuration: &configuration::Configuration, ) -> Result<models::IserverReauthenticateGet200Response, Error<IserverReauthenticateGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::IserverReauthenticateGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::IserverReauthenticateGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn logout_post(configuration: &configuration::Configuration, ) -> Result<models::LogoutPost200Response, Error<LogoutPostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LogoutPost200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LogoutPost200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn sso_validate_get(configuration: &configuration::Configuration, ) -> Result<models::SsoValidateResponse, Error<SsoValidateGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SsoValidateResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SsoValidateResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn tickle_post(configuration: &configuration::Configuration, ) -> Result<models::TickleResponse, Error<TicklePostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TickleResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TickleResponse`")))),
        }
    } else {
        let content = resp.text().await?;
