...
pub async fn iserver_contract_conid_algos_get(configuration: &configuration::Configuration, conid: &str, algos: Option<&str>, add_description: Option<&str>, add_params: Option<&str>) -> Result<models::AlgosResponse, Error<IserverContractConidAlgosGetError>> {
    ...
    let uri_str = format!("{}/iserver/contract/{conid}/algos", configuration.base_path, conid=crate::apis::urlencode(p_conid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AlgosResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AlgosResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_contract_conid_info_and_rules_get(configuration: &configuration::Configuration, conid: &str) -> Result<models::IserverContractConidInfoAndRulesGet200Response, Error<IserverContractConidInfoAndRulesGetError>> {
    ...
    let uri_str = format!("{}/iserver/contract/{conid}/info-and-rules", configuration.base_path, conid=crate::apis::urlencode(p_conid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::IserverContractConidInfoAndRulesGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::IserverContractConidInfoAndRulesGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<IserverContractConidInfoAndRulesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn iserver_contract_conid_info_get(configuration: &configuration::Configuration, conid: &str) -> Result<models::ContractInfo, Error<IserverContractConidInfoGetError>> {
    ...
    let uri_str = format!("{}/iserver/contract/{conid}/info", configuration.base_path, conid=crate::apis::urlencode(p_conid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ContractInfo`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ContractInfo`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_contract_rules_post(configuration: &configuration::Configuration, iserver_contract_rules_post_request: models::IserverContractRulesPostRequest) -> Result<models::ContractRules, Error<IserverContractRulesPostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ContractRules`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ContractRules`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_currency_pairs_get(configuration: &configuration::Configuration, currency: &str) -> Result<std::collections::HashMap<String, Vec<models::CurrencyPairsValueInner>>, Error<IserverCurrencyPairsGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `std::collections::HashMap&lt;String, Vec&lt;models::CurrencyPairsValueInner&gt;&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `std::collections::HashMap&lt;String, Vec&lt;models::CurrencyPairsValueInner&gt;&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_exchangerate_get(configuration: &configuration::Configuration, target: &str, source: &str) -> Result<models::IserverExchangerateGet200Response, Error<IserverExchangerateGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::IserverExchangerateGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::IserverExchangerateGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_secdef_bond_filters_get(configuration: &configuration::Configuration, symbol: &str, issue_id: &str) -> Result<models::BondFiltersResponse, Error<IserverSecdefBondFiltersGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BondFiltersResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BondFiltersResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_secdef_info_get(configuration: &configuration::Configuration, conid: Option<&str>, sectype: Option<models::serde_json::Value>, month: Option<models::serde_json::Value>, exchange: Option<models::serde_json::Value>, strike: Option<models::serde_json::Value>, right: Option<&str>, issuer_id: Option<&str>, filters: Option<models::serde_json::Value>) -> Result<models::SecDefInfoResponse, Error<IserverSecdefInfoGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SecDefInfoResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SecDefInfoResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_secdef_search_get(configuration: &configuration::Configuration, symbol: Option<&str>, sec_type: Option<&str>, name: Option<bool>, more: Option<bool>, fund: Option<bool>, fund_family_conid_ex: Option<&str>, pattern: Option<bool>, referrer: Option<&str>) -> Result<Vec<models::SecdefSearchResponseInner>, Error<IserverSecdefSearchGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::SecdefSearchResponseInner&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::SecdefSearchResponseInner&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn iserver_secdef_strikes_get(configuration: &configuration::Configuration, conid: &str, sectype: &str, month: &str, exchange: Option<&str>) -> Result<models::IserverSecdefStrikesGet200Response, Error<IserverSecdefStrikesGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::IserverSecdefStrikesGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::IserverSecdefStrikesGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn trsrv_all_conids_get(configuration: &configuration::Configuration, exchange: &str, asset_class: Option<models::serde_json::Value>) -> Result<Vec<models::TrsrvAllConidsGet200ResponseInner>, Error<TrsrvAllConidsGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::TrsrvAllConidsGet200ResponseInner&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::TrsrvAllConidsGet200ResponseInner&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn trsrv_secdef_get(configuration: &configuration::Configuration, conids: &str, UNKNOWN_PARAMETER_NAME: Option<models::>, UNKNOWN_PARAMETER_NAME2: Option<models::>) -> Result<models::TrsrvSecDefResponse, Error<TrsrvSecdefGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_conids = conids;
    ...
    if let Some(ref param_value) = p_UNKNOWN_PARAMETER_NAME {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TrsrvSecDefResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TrsrvSecDefResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn trsrv_secdef_schedule_get(configuration: &configuration::Configuration, asset_class: &str, symbol: &str, exchange: Option<&str>, exchange_filter: Option<&str>) -> Result<Vec<models::TradingScheduleInner>, Error<TrsrvSecdefScheduleGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::TradingScheduleInner&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::TradingScheduleInner&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn trsrv_stocks_get(configuration: &configuration::Configuration, symbols: &str) -> Result<std::collections::HashMap<String, Vec<models::StocksValueInner>>, Error<TrsrvStocksGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `std::collections::HashMap&lt;String, Vec&lt;models::StocksValueInner&gt;&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `std::collections::HashMap&lt;String, Vec&lt;models::StocksValueInner&gt;&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
