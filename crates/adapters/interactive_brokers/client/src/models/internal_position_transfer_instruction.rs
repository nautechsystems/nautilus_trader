...
impl InternalPositionTransferInstruction {
    pub fn new(client_instruction_id: f64, source_account_id: String, target_account_id: String, transfer_quantity: f64, trading_instrument: Option<serde_json::Value>) -> InternalPositionTransferInstruction {
