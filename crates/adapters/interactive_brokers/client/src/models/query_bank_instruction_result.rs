...
impl QueryBankInstructionResult {
    pub fn new(account_id: String, bank_instruction_method: BankInstructionMethod, client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> QueryBankInstructionResult {
