...
impl DepositFundsInstructionIraDepositDetail {
    pub fn new(ira_contribution_type: IraContributionType, ira_tax_year_type: IraTaxYearType, from_ira_type: FromIraType) -> DepositFundsInstructionIraDepositDetail {
