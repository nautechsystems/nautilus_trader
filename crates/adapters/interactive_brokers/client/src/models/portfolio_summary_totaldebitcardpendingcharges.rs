...
pub struct PortfolioSummaryTotaldebitcardpendingcharges {
...
impl PortfolioSummaryTotaldebitcardpendingcharges {
    pub fn new() -> PortfolioSummaryTotaldebitcardpendingcharges {
