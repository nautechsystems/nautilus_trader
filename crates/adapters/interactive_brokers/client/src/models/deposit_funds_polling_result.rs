...
pub struct DepositFundsPollingResult {
    ...
    pub deposit_details: Option<Box<models::DepositFundsPollingResultAllOfDepositDetails>>,
}

impl DepositFundsPollingResult {
    pub fn new(client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> DepositFundsPollingResult {
