...
pub struct QueryRecurringInstructionsResult {
    ...
    pub recurring_instructions: Vec<serde_json::Value>,
...
impl QueryRecurringInstructionsResult {
    pub fn new(account_id: String, recurring_instructions: Vec<serde_json::Value>, client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> QueryRecurringInstructionsResult {
