...
pub struct PortfolioSummaryPreviousdayequitywithloanvalue {
...
impl PortfolioSummaryPreviousdayequitywithloanvalue {
    pub fn new() -> PortfolioSummaryPreviousdayequitywithloanvalue {
