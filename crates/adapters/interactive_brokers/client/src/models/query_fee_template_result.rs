...
pub struct QueryFeeTemplateResult {
    #[serde(rename = "templateDetails")]
    pub template_details: Box<serde_json::Value>,
...
impl QueryFeeTemplateResult {
    pub fn new(template_details: serde_json::Value, client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> QueryFeeTemplateResult {
        QueryFeeTemplateResult {
            template_details: Box::new(template_details),
