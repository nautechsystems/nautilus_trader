...
pub struct Presets {
    ...
    #[serde(
        rename = "group_auto_close_positions",
    ...
    #[serde(
        rename = "profiles_auto_close_positions",
        skip_serializing_if = "Option::is_none"
    )]
