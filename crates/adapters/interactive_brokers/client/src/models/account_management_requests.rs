...
pub struct AccountManagementRequests {
    ...
    #[serde(
        rename = "updateWithholdingStatement",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "changeAccountHolderDetail",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "createUserForSecondHolder",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "manageMarketDataSubscriptions",
        skip_serializing_if = "Option::is_none"
    )]
