...
impl PredefinedDestinationInstruction {
    pub fn new(client_instruction_id: f64, bank_instruction_name: String, bank_instruction_method: BankInstructionMethod, account_id: String, currency: String, financial_institution: models::PredefinedDestinationInstructionFinancialInstitution) -> PredefinedDestinationInstruction {
