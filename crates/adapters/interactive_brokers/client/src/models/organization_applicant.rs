...
pub struct OrganizationApplicant {
    ...
    #[serde(rename = "qualifiedIntermediary", skip_serializing_if = "Option::is_none")]
    pub qualified_intermediary: Option<bool>,
    #[serde(rename = "assumedPrimaryReporting", skip_serializing_if = "Option::is_none")]
    pub assumed_primary_reporting: Option<bool>,
    #[serde(rename = "acceptedPrimaryWithholding", skip_serializing_if = "Option::is_none")]
