...
impl DeleteBankInstruction {
    pub fn new(client_instruction_id: f64, account_id: String, bank_instruction_name: String, bank_instruction_method: BankInstructionMethod, currency: String) -> DeleteBankInstruction {
