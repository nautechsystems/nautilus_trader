...
impl PollingInstructionResult {
    pub fn new(client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> PollingInstructionResult {
