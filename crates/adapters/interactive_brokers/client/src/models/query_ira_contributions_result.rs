...
pub struct QueryIraContributionsResult {
    ...
    pub contributions: Vec<models::QueryIraContributionsResultAllOfContributions>,
}

impl QueryIraContributionsResult {
    pub fn new(client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64, account_id: String, year: String, ira_type: String, contributions: Vec<models::QueryIraContributionsResultAllOfContributions>) -> QueryIraContributionsResult {
