...
impl QueryWithdrawableAmountsWithoutOriginHoldResult {
    pub fn new(client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64, account_id: String, currency: String, withdrawable_amount_without_origination_hold: f64, withdrawable_amount_without_origination_hold_no_borrow: f64) -> QueryWithdrawableAmountsWithoutOriginHoldResult {
        QueryWithdrawableAmountsWithoutOriginHoldResult {
            ...
            account_id,
            currency,
            withdrawable_amount_without_origination_hold,
