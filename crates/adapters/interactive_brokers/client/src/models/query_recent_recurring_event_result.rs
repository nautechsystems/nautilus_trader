...
impl QueryRecentRecurringEventResult {
    pub fn new(recurring_instruction_name: String, recurring_transaction_type: String, recurring_transaction_status: String, amount: f64, currency: String, method: String, transaction_history: serde_json::Value, client_instruction_id: f64, instruction_type: InstructionType, instruction_status: InstructionStatus, instruction_id: f64) -> QueryRecentRecurringEventResult {
