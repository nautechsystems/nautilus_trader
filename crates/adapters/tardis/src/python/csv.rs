...
use crate::csv::{
    ...
    load_trade_ticks, stream_deltas, stream_depth10_from_snapshot5, stream_depth10_from_snapshot25,
...
#[pyo3(signature = (filepath, chunk_size, price_precision=None, size_precision=None, instrument_id=None))]
