...
//! Kalshi enumerations Python bindings.

use pyo3::prelude::*;

use crate::common::enums::{KalshiEnvironment, KalshiSelfTradePrevention};
...
impl KalshiEnvironment {
    ...
    fn __repr__(&self) -> String {
        format!("KalshiEnvironment.{}", self.__str__())
    }
...
impl KalshiSelfTradePrevention {
    ...
    fn __repr__(&self) -> String {
        format!("KalshiSelfTradePrevention.{}", self.__str__())
    }
