...
//! [`nonce`].
//!
//! The byte-equivalence oracle is
//! `test_data/common/signing_trade_action_vectors.json`, generated by
//! `scripts/oracle-py/derive/generate_oracle.py` from the upstream Python SDK at a
//! revision pinned in the fixture metadata and replayed against this
//! implementation in [`eip712`] tests. A future re-pin (for example a V3
//! signer) regenerates the fixture through the generator; the Rust test
//! structure stays unchanged. Third-party attribution for the oracle is
//! recorded in `licenses/THIRD_PARTY_LICENSES.md`.
//!
