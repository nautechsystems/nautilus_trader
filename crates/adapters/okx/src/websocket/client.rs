...
use super::{
    ...
    parse::{
        self, parse_book_msg_vec, parse_candle_msg_vec, parse_index_price_msg_vec,
        parse_mark_price_msg_vec, parse_quote_msg_vec, parse_ticker_msg_vec, parse_trade_msg_vec,
    },
};
use crate::{
    common::{
        ...
        parse::{
            bar_spec_as_okx_channel, okx_instrument_type, parse_account_state, parse_instrument_any,
        },
    },
...
impl OKXWsMessageHandler {
    ...
    async fn next(&mut self) -> Option<NautilusWsMessage> {
        ...
        while let Some(event) = self.handler.next().await {
            ...
            if let OKXWebSocketEvent::Data { arg, data } = event {
                ...
                if arg.channel == OKXWsChannel::Orders {
                    ...
                    let data: Vec<OKXOrderMsg> = serde_json::from_value(data).unwrap();
                ...
                match arg.channel {
                    OKXWsChannel::Instruments => {
                        if let Ok(msg) = serde_json::from_value::<OKXInstrument>(data.clone()) {
                            match parse_instrument_any(&msg, ts_init) {
                                Ok(Some(inst_any)) => {
                                    return Some(NautilusWsMessage::Instrument(Box::new(inst_any)));
                                }
                                Ok(None) => tracing::warn!("Empty instrument payload: {:?}", msg),
                                Err(e) => tracing::error!("Error parsing instrument: {e}"),
                            }
                        } else {
                            tracing::error!("Failed to deserialize instrument payload");
                        }
                    }
                    OKXWsChannel::BboTbt => {
                        match parse_quote_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            size_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing quote msg: {e}"),
                        }
                    }
                    OKXWsChannel::Tickers => {
                        match parse_ticker_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            size_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing ticker msg: {e}"),
                        }
                    }
                    OKXWsChannel::Trades => {
                        match parse_trade_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            size_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing trade msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPrice => {
                        match parse_mark_price_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ts_init,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark price msg: {e}"),
                        }
                    }
                    OKXWsChannel::IndexTickers => {
                        match parse_index_price_msg_vec(
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing index price msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Second => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            size_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1s msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1m msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle3Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle3m msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle5Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle5m msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle15Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle15m msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle30Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle30m msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1h msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle2Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle2h msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle4Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle4h msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle6Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle6h msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle12Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle12h msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1d msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle2Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle2d msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle3Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle3d msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle5Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle5d msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Week => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1w msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Month => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1mo msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle3Month => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle3mo msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle6Month => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle6mo msg: {e}"),
                        }
                    }
                    OKXWsChannel::Candle1Year => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing candle1y msg: {e}"),
                        }
                    }
                    // Mark Price Candlesticks
                    OKXWsChannel::MarkPriceCandle1Second => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle1s msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle1Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle1m msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle3Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle3m msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle5Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle5m msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle15Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => {
                                tracing::error!("Error parsing mark-price-candle15m msg: {e}")
                            }
                        }
                    }
                    OKXWsChannel::MarkPriceCandle30Minute => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => {
                                tracing::error!("Error parsing mark-price-candle30m msg: {e}")
                            }
                        }
                    }
                    OKXWsChannel::MarkPriceCandle1Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle1h msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle2Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle2h msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle4Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle4h msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle6Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle6h msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle12Hour => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => {
                                tracing::error!("Error parsing mark-price-candle12h msg: {e}")
                            }
                        }
                    }
                    OKXWsChannel::MarkPriceCandle1Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle1d msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle2Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle2d msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle3Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle3d msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle5Day => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle5d msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle1Week => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => tracing::error!("Error parsing mark-price-candle1w msg: {e}"),
                        }
                    }
                    OKXWsChannel::MarkPriceCandle1Month => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => {
                                tracing::error!("Error parsing mark-price-candle1mo msg: {e}")
                            }
                        }
                    }
                    OKXWsChannel::MarkPriceCandle3Month => {
                        match parse_candle_msg_vec(
                            data,
                            &instrument_id,
                            price_precision,
                            ...
                            Ok(v) => return Some(NautilusWsMessage::Data(v)),
                            Err(e) => {
                                tracing::error!("Error parsing mark-price-candle3mo msg: {e}")
                            }
                        }
                    }
                    _ => tracing::warn!("Unhandled data channel: {:?}", arg.channel),
                }
                continue;
            }
