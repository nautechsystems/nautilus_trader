...
use ahash::AHashMap;
use nautilus_core::serialization::{decimal, deserialize_optional_decimal_token};
use rust_decimal::Decimal;
use serde::{Deserialize, Serialize};
use ustr::Ustr;

use crate::common::serialization::{
    deserialize_decimal_token_or_zero, deserialize_decimal_token_pairs,
    deserialize_decimal_token_vec,
};
...
pub struct DeribitTradingViewChartData {
    ...
    #[serde(deserialize_with = "deserialize_decimal_token_vec")]
...
pub struct DeribitOrderBook {
    ...
    #[serde(deserialize_with = "deserialize_decimal_token_pairs")]
