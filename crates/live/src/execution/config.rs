...
use super::submission::SubmittedOrderExhaustionPolicy;
...
pub struct ExecutionManagerConfig {
    ...
    /// Behavior when a submitted order exhausts automatic recovery.
...
impl Default for ExecutionManagerConfig {
    fn default() -> Self {
        Self {
            ...
            submitted_order_exhaustion_policy: SubmittedOrderExhaustionPolicy::default(),
