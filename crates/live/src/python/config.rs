...
use crate::config::{
    ...
    QueueMonitorConfig, RoutingConfig, SubmittedOrderExhaustionPolicy, duration_from_secs_f64,
...
impl LiveExecutionEngineConfig {
    ...
    fn py_new(
        ...
        submitted_order_exhaustion_policy: Option<SubmittedOrderExhaustionPolicy>,
    ) -> PyResult<Self> {
        let default = Self::default();
        ...
        let config = Self {
            ...
            submitted_order_exhaustion_policy: submitted_order_exhaustion_policy
                .unwrap_or(default.submitted_order_exhaustion_policy),
    ...
    #[getter]
    #[pyo3(name = "submitted_order_exhaustion_policy")]
    const fn py_submitted_order_exhaustion_policy(&self) -> SubmittedOrderExhaustionPolicy {
        self.submitted_order_exhaustion_policy
    }
