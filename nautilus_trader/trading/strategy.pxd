...
# -- MANAGEMENT METHODS ----------------------------------------------------------------------------
    ...
    cpdef dict orders(self, Symbol symbol=*)
    cpdef dict orders_working(self, Symbol symbol=*)
    cpdef dict orders_completed(self, Symbol symbol=*)
    ...
    cpdef dict positions(self, Symbol symbol=*)
