...
from nautilus_trader.adapters.betfair.spec.markets import MarketCatalog
...
def market_catalog_to_instruments(
    ...
    for runner in market_catalog.runners:
        instrument = BettingInstrument(
            ...
            competition_id=market_catalog.competition.id,
            competition_name=market_catalog.competition.name,
...
def market_definition_to_instruments(
    ...
    for runner in market_definition.runners:
        instrument = BettingInstrument(
            ...
            ts_event=time.time_ns(),
            ts_init=time.time_ns(),
            info=msgspec.json.encode(market_definition),
        )
        instruments.append(instrument)
    return instruments
