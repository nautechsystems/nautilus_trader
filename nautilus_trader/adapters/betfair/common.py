...
BETFAIR_TICK_SCHEME = TieredTickScheme(name="betfair_prob", tiers=BETFAIR_PRICE_TIERS)

BETFAIR_FLOAT_TO_PRICE = {price.to_double(): price for price in BETFAIR_TICK_SCHEME.ticks}

MAX_BET_PROB = max(BETFAIR_TICK_SCHEME.ticks)
MIN_BET_PROB = min(BETFAIR_TICK_SCHEME.ticks)
