...
class BinanceSpotBalanceInfo(msgspec.Struct, frozen=True):
    """
    HTTP response 'inner struct' from `Binance Spot/Margin` GET /api/v3/account
    (HMAC SHA256).
    """
...
class BinanceSpotOrderOco(msgspec.Struct, frozen=True):
    """
    HTTP response from `Binance Spot/Margin` GET /api/v3/orderList (HMAC
    SHA256).

    HTTP response from `Binance Spot/Margin` POST /api/v3/order/oco (HMAC
    SHA256). HTTP response from `Binance Spot/Margin` DELETE /api/v3/orderList
    (HMAC SHA256).
