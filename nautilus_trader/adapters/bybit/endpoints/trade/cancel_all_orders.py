...
from nautilus_trader.adapters.bybit.common.enums import BybitInstrumentType, BybitEndpointType
...
class BybitCancelAllOrdersEndpoint(BybitHttpEndpoint):
    ...
    async def post(self, parameters: BybitCancelAllOrdersPostParameters) -> BybitCancelAllOrdersResponse:
