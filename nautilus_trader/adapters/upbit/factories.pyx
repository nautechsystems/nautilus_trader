...
from nautilus_trader.adapters.upbit.data cimport UpbitDataClient
from nautilus_trader.adapters.upbit.execution cimport UpbitExecutionClient
...
cdef class UpbitDataClientFactory(LiveDataClientFactory):
    """
    ...
    def create(
        ...
        if client_cls is None:
            ...
            client_cls: ccxtpro.Exchange = getattr(ccxtpro, name.lower())
...
cdef class UpbitExecutionClientFactory(LiveExecutionClientFactory):
    """
    Provides data and execution clients for the unified CCXT Pro API.
    """
