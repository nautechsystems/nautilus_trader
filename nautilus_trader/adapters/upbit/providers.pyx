...
cdef class UpbitInstrumentProvider(InstrumentProvider):
    """
    ...
    cdef void _load_instruments(self) except *:
        ...
        for k, v in self._client.markets.items():
            """
{'active': True,
 'base': 'Tokamak Network',
 'baseId': 'TON',
 'id': 'KRW-TON',
 'info': {'english_name': 'TON', 'korean_name': '톤', 'market': 'KRW-TON'},
 'limits': {'amount': {'max': None, 'min': 1e-08},
