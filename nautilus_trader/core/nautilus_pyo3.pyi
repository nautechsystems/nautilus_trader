...
class DatabentoDataLoader:
    ...
    def load_order_book_deltas_as_pycapsule(self, path: str, instrument_id: InstrumentId | None) -> object: ...
    ...
    def load_quotes_as_pycapsule(self, path: str, instrument_id: InstrumentId | None) -> object: ...
