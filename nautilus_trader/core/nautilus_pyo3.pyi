...
class PyStrikeRange:
    @staticmethod
    def fixed(strikes: list[Price]) -> PyStrikeRange: ...
    @staticmethod
...
class PyAtmSource:
    @staticmethod
    def mark_price(instrument_id: InstrumentId) -> PyAtmSource: ...
    @staticmethod
    def index_price(instrument_id: InstrumentId) -> PyAtmSource: ...
    @staticmethod
    def underlying_quote_mid(instrument_id: InstrumentId) -> PyAtmSource: ...
    @staticmethod
    def forward_price() -> PyAtmSource: ...
    @property
