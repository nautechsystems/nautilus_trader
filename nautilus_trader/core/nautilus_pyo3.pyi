...
class MarginAccount:
    ...
    def borrow(self, currency: Currency) -> BorrowBalance | None: ...
    def borrows(self) -> dict[Currency, BorrowBalance]: ...
    def borrowed(self, currency: Currency) -> Money | None: ...
    def accrued_interest(self, currency: Currency) -> Money | None: ...
    def update_borrow(self, borrow: BorrowBalance) -> None: ...
    def clear_borrow(self, currency: Currency) -> None: ...
...
class BorrowBalance:
    def __init__(self, borrowed: Money, accrued_interest: Money): ...
    @classmethod
    def from_dict(cls, values: dict[str, str]) -> BorrowBalance: ...
    def to_dict(self) -> dict[str, str]: ...
...
class AccountState:
    ...
    @property
    def borrows(self) -> list[BorrowBalance]: ...
