...
def get_databento_arrow_schema_map(cls: type) -> dict[str, str]: ...
def py_databento_statistics_to_arrow_record_batch_bytes(
    data: list[DatabentoStatistics],
) -> bytes: ...
def py_databento_imbalance_to_arrow_record_batch_bytes(
