...
class OwnOrderBook:
    ...
    def clear(self) -> None: ...
    def bids_to_dict(self, status: set[OrderStatus] | None = None) -> dict[Decimal, list[OwnBookOrder]]: ...
    def asks_to_dict(self, status: set[OrderStatus] | None = None) -> dict[Decimal, list[OwnBookOrder]]: ...
    def bid_quantity(self, status: set[OrderStatus] | None = None) -> dict[Decimal, Decimal]: ...
    def ask_quantity(self, status: set[OrderStatus] | None = None) -> dict[Decimal, Decimal]: ...
    def pprint(self, num_levels: int = 3) -> str: ...
