...
class DataActor:
    ...
    def on_borrow_rate(self, borrow_rate: BorrowRate) -> None: ...
...
class BorrowRate:
    def __init__(
        ...
        venue: Venue,
        rate: Decimal,
        accrual_interval: int,
        ts_event: int,
        ts_init: int,
        next_accrual_ns: int | None = None,
        borrow_limit: Money | None = None,
    ) -> None: ...
    @property
    ...
    def rate(self) -> Decimal: ...
    @property
    def accrual_interval(self) -> int: ...
    @property
    def next_accrual_ns(self) -> int | None: ...
    @property
    def borrow_limit(self) -> Money | None: ...
    @property
    def ts_event(self) -> int: ...
    @property
    def ts_init(self) -> int: ...
    ...
    def fully_qualified_name() -> str: ...
    @staticmethod
    def get_metadata(currency: Currency, venue: Venue) -> dict[str, str]: ...
    @staticmethod
    def get_fields() -> dict[str, str]: ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> BorrowRate: ...
    @staticmethod
    def from_json(data: bytes) -> BorrowRate: ...
    @staticmethod
    def from_msgpack(data: bytes) -> BorrowRate: ...
    def to_dict(self) -> dict[str, Any]: ...
    def to_json(self) -> bytes: ...
    def to_msgpack(self) -> bytes: ...
