...
const char *component_state_to_cstr(enum ActorState value);
 ...
 */
enum ActorState component_state_from_cstr(const char *ptr);

const char *component_trigger_to_cstr(enum ActorTrigger value);
 ...
 * Panics if the input C string does not match a valid enum variant.
 */
enum ActorTrigger component_trigger_from_cstr(const char *ptr);
