...
cdef class Condition:
    ...
    @staticmethod
    cdef void equal(object argument1, object argument2, str param1, str param2, ex_type=*) except *
    @staticmethod
    cdef void not_equal(object argument1, object argument2, str param1, str param2, ex_type=*) except *
    @staticmethod
    cdef void list_type(list argument, type expected_type, str param, ex_type=*) except *
    @staticmethod
    cdef void dict_types(dict argument, type key_type, type value_type, str param, ex_type=*) except *
    @staticmethod
    cdef void is_in(object element, object collection, str param1, str param2, ex_type=*) except *
    @staticmethod
    cdef void not_in(object element, object collection, str param1, str param2, ex_type=*) except *
    @staticmethod
    ...
    @staticmethod
    cdef void in_range(double value, double start, double end, str param, ex_type=*) except *
    @staticmethod
    cdef void in_range_int(int value, int start, int end, str param, ex_type=*) except *
    @staticmethod
