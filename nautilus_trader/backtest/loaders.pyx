...
cdef class InstrumentLoader:
    ...
    def default_fx_ccy(Symbol symbol, leverage: Decimal=Decimal("50")) -> Instrument:
        ...
        return Instrument(
            ...
            asset_type=AssetType.SPOT,
            base_currency=Currency.from_str_c(base_currency),
            quote_currency=Currency.from_str_c(quote_currency),
            settlement_currency=Currency.from_str_c(quote_currency),
            is_inverse=False,
