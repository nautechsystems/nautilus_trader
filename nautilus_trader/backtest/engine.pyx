...
cdef class BacktestEngine:
    ...
    def __init__(
        ...
        venue : Venue
            The venue for the backtest engine.
        oms_type : OMSType
            The order management system type for the backtest engine.
        generate_position_ids : bool
            If position identifiers should be generated by the engine side.
