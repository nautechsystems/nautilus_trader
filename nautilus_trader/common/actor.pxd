...
# -- SUBSCRIPTIONS --------------------------------------------------------------------------------
    ...
    cpdef void subscribe_quote_ticks_batch(self, list instrument_ids, ClientId client_id=*, dict params=*)
    ...
    cpdef void subscribe_trade_ticks_batch(self, list instrument_ids, ClientId client_id=*, dict params=*)
    ...
    cpdef void subscribe_bars_batch(self, list bar_types, ClientId client_id=*, bint update_catalog=*, dict params=*)
