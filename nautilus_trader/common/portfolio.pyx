...
cdef class Portfolio:
    ...
    cdef void _handle_position_modified(self, PositionModified event):
        ...
        if position.entry_direction != fill_event.order_side:
            # Increment PNL
            self.daily_pnl_realized.add(position.realized_pnl_last)
            self.total_pnl_realized.add(position.realized_pnl_last)
    ...
    cdef void _handle_position_closed(self, PositionClosed event):
        ...
        # Increment PNL
        self.daily_pnl_realized.add(position.realized_pnl)
        self.total_pnl_realized.add(position.realized_pnl)
