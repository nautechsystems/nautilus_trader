...
NAUTILUS_PARQUET_SCHEMA = {
    OrderBookData: pa.schema(
        {
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
            "action": pa.string(),
            "side": pa.string(),
            ...
            "_type": pa.dictionary(pa.uint8(), pa.string()),
            "_last": pa.bool_(),
        },
    ...
    TradeTick: pa.schema(
        {
            ...
            "price": pa.string(),
            "size": pa.string(),
            "aggressor_side": pa.dictionary(pa.uint8(), pa.string()),
            "trade_id": pa.string(),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
        },
    ...
    Bar: pa.schema(
        {
            "bar_type": pa.dictionary(pa.uint8(), pa.string()),
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "open": pa.string(),
            "high": pa.string(),
            "low": pa.string(),
    ...
    VenueStatusUpdate: pa.schema(
        {
            "venue": pa.dictionary(pa.uint8(), pa.string()),
            "status": pa.dictionary(pa.uint8(), pa.string()),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
        },
    ...
    InstrumentClose: pa.schema(
        {
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "close_type": pa.dictionary(pa.uint8(), pa.string()),
    ...
    ComponentStateChanged: pa.schema(
        {
            "trader_id": pa.dictionary(pa.uint8(), pa.string()),
            "component_id": pa.dictionary(pa.uint8(), pa.string()),
            "component_type": pa.dictionary(pa.uint8(), pa.string()),
            "state": pa.string(),
            "config": pa.string(),
            "event_id": pa.string(),
            "ts_event": pa.uint64(),
    ...
    AccountState: pa.schema(
        {
            "account_id": pa.dictionary(pa.uint8(), pa.string()),
            "account_type": pa.dictionary(pa.uint8(), pa.string()),
            "base_currency": pa.dictionary(pa.uint16(), pa.string()),
            "balance_total": pa.float64(),
            "balance_locked": pa.float64(),
            "balance_free": pa.float64(),
            "balance_currency": pa.dictionary(pa.uint16(), pa.string()),
            "margin_initial": pa.float64(),
            "margin_maintenance": pa.float64(),
            "margin_currency": pa.dictionary(pa.uint16(), pa.string()),
            "margin_instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "reported": pa.bool_(),
            "info": pa.binary(),
            "event_id": pa.string(),
            "ts_event": pa.uint64(),
    ...
    OrderInitialized: pa.schema(
        {
            "trader_id": pa.dictionary(pa.uint8(), pa.string()),
            "strategy_id": pa.dictionary(pa.uint16(), pa.string()),
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "client_order_id": pa.string(),
            "order_side": pa.dictionary(pa.uint8(), pa.string()),
            "order_type": pa.dictionary(pa.uint8(), pa.string()),
            "quantity": pa.float64(),
            "time_in_force": pa.dictionary(pa.uint8(), pa.string()),
            "post_only": pa.bool_(),
            "reduce_only": pa.bool_(),
            # -- Options fields -- #
            "price": pa.float64(),
            "trigger_price": pa.string(),
            "trigger_type": pa.dictionary(pa.uint8(), pa.string()),
            "limit_offset": pa.string(),
            "trailing_offset": pa.string(),
            "trailing_offset_type": pa.dictionary(pa.uint8(), pa.string()),
    ...
    OrderDenied: pa.schema(
        {
            "trader_id": pa.dictionary(pa.uint8(), pa.string()),
            "strategy_id": pa.dictionary(pa.uint8(), pa.string()),
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "client_order_id": pa.string(),
            "reason": pa.dictionary(pa.uint8(), pa.string()),
            "event_id": pa.string(),
            "ts_init": pa.uint64(),
        },
    ),
    ...
    CurrencyPair: pa.schema(
        {
            "id": pa.dictionary(pa.uint64(), pa.string()),
            "native_symbol": pa.string(),
            "base_currency": pa.dictionary(pa.uint16(), pa.string()),
            "quote_currency": pa.dictionary(pa.uint16(), pa.string()),
            "price_precision": pa.uint8(),
            "size_precision": pa.uint8(),
            "price_increment": pa.dictionary(pa.uint8(), pa.string()),
            "size_increment": pa.dictionary(pa.uint8(), pa.string()),
            "lot_size": pa.dictionary(pa.uint8(), pa.string()),
            "max_quantity": pa.dictionary(pa.uint16(), pa.string()),
            "min_quantity": pa.dictionary(pa.uint16(), pa.string()),
            "max_notional": pa.dictionary(pa.uint16(), pa.string()),
            "min_notional": pa.dictionary(pa.uint16(), pa.string()),
            "max_price": pa.dictionary(pa.uint16(), pa.string()),
            "min_price": pa.dictionary(pa.uint16(), pa.string()),
    ...
    CryptoPerpetual: pa.schema(
        {
            ...
            "base_currency": pa.dictionary(pa.uint16(), pa.string()),
            "quote_currency": pa.dictionary(pa.uint16(), pa.string()),
            "settlement_currency": pa.dictionary(pa.uint16(), pa.string()),
            "is_inverse": pa.bool_(),
            "price_precision": pa.uint8(),
            "size_precision": pa.uint8(),
            "price_increment": pa.dictionary(pa.uint8(), pa.string()),
    ...
    CryptoFuture: pa.schema(
        {
            "id": pa.dictionary(pa.uint64(), pa.string()),
            "native_symbol": pa.string(),
            "underlying": pa.dictionary(pa.uint16(), pa.string()),
            "quote_currency": pa.dictionary(pa.uint16(), pa.string()),
            "settlement_currency": pa.dictionary(pa.uint16(), pa.string()),
            "expiry_date": pa.dictionary(pa.uint8(), pa.string()),
            "price_precision": pa.uint8(),
            "size_precision": pa.uint8(),
            "price_increment": pa.dictionary(pa.uint8(), pa.string()),
            "size_increment": pa.dictionary(pa.uint8(), pa.string()),
            ...
            "max_notional": pa.dictionary(pa.uint16(), pa.string()),
            "min_notional": pa.dictionary(pa.uint16(), pa.string()),
            "max_price": pa.dictionary(pa.uint8(), pa.string()),
            "min_price": pa.dictionary(pa.uint8(), pa.string()),
            "margin_init": pa.string(),
            "margin_maint": pa.string(),
            "maker_fee": pa.string(),
            "taker_fee": pa.string(),
    ...
    Equity: pa.schema(
        {
            "id": pa.dictionary(pa.uint64(), pa.string()),
            "native_symbol": pa.string(),
            "currency": pa.dictionary(pa.uint16(), pa.string()),
            "price_precision": pa.uint8(),
            "size_precision": pa.uint8(),
            "price_increment": pa.dictionary(pa.uint8(), pa.string()),
            "size_increment": pa.dictionary(pa.uint8(), pa.string()),
            "multiplier": pa.dictionary(pa.uint8(), pa.string()),
            "lot_size": pa.dictionary(pa.uint8(), pa.string()),
            "isin": pa.string(),
            "margin_init": pa.string(),
            "margin_maint": pa.string(),
    ...
    Future: pa.schema(
        {
            ...
            "native_symbol": pa.string(),
            "underlying": pa.dictionary(pa.uint16(), pa.string()),
            "asset_class": pa.dictionary(pa.uint8(), pa.string()),
            "currency": pa.dictionary(pa.uint16(), pa.string()),
            "price_precision": pa.uint8(),
            "size_precision": pa.uint8(),
            "price_increment": pa.dictionary(pa.uint8(), pa.string()),
    ...
    Option: pa.schema(
        {
            ...
            "multiplier": pa.dictionary(pa.uint8(), pa.string()),
            "lot_size": pa.dictionary(pa.uint8(), pa.string()),
            "expiry_date": pa.dictionary(pa.uint64(), pa.string()),
            "strike_price": pa.dictionary(pa.uint64(), pa.string()),
            "kind": pa.dictionary(pa.uint8(), pa.string()),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
        },
    ),
    BinanceBar: pa.schema(
        {
            "bar_type": pa.dictionary(pa.uint16(), pa.string()),
            "instrument_id": pa.dictionary(pa.uint64(), pa.string()),
            "open": pa.string(),
            "high": pa.string(),
            "low": pa.string(),
