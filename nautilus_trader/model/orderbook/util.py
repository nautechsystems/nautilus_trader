...
def depth_at_price(self, price, depth_type="volume"):
    ...
    idx = bisect_idx_depth(v=price, values=self.get_attrib("price"), reverse=self.reverse)
...
def depth_for_volume(self: Level, value, depth_type="volume"):
    """
...
def exposure_fill_price(self: Ladder, exposure):
    """
...
def volume_fill_price(self: Ladder, volume):
    """
...
def auction_match(self: Ladder, other: Ladder, on="volume"):
    """
