...
cdef class Position:
    ...
    cdef inline Decimal _calculate_avg_price(self, Decimal open_price, Decimal open_quantity, OrderFilled event)
    ...
    cdef inline Money _calculate_pnl(self, Decimal open_price, Decimal close_price, Decimal filled_qty)
