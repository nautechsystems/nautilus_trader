...
cdef class TokenizedAsset(Instrument):
    ...
    @staticmethod
    def from_dict(dict values) -> TokenizedAsset:
        """
        ...
        """
        return TokenizedAsset.from_dict_c(values)

    @staticmethod
    def to_dict(TokenizedAsset obj) -> dict[str, object]:
        """
        ...
        """
        return TokenizedAsset.to_dict_c(obj)
    ...
    def from_pyo3(pyo3_instrument):
        return TokenizedAsset.from_pyo3_c(pyo3_instrument)
