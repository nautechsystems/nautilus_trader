...
cdef class CryptoOptionSpread(Instrument):
    """
    Represents a crypto option spread instrument, with crypto assets as underlying
    and for settlement.
    ...
    strategy_type : str
        The strategy type for the spread (e.g., ``CS``, ``STRG``).
    ...
    @staticmethod
    cdef CryptoOptionSpread from_dict_c(dict values):
    ...
    @staticmethod
    cdef dict to_dict_c(CryptoOptionSpread obj):
        Condition.not_none(obj, "obj")
        return {
            "type": "CryptoOptionSpread",
            "id": obj.id.to_str(),
    ...
    @staticmethod
    cdef CryptoOptionSpread from_pyo3_c(pyo3_instrument):
    ...
    @staticmethod
    def from_dict(dict values) -> CryptoOptionSpread:
        """
        ...
        """
        return CryptoOptionSpread.from_dict_c(values)

    @staticmethod
    def to_dict(CryptoOptionSpread obj) -> dict[str, object]:
        """
        ...
        """
        return CryptoOptionSpread.to_dict_c(obj)

    @staticmethod
    def from_pyo3(pyo3_instrument) -> CryptoOptionSpread:
        """
        Return legacy Cython crypto option spread instrument converted from the given pyo3 Rust object.

        Parameters
        ----------
        pyo3_instrument : nautilus_pyo3.CryptoOptionSpread
            The pyo3 Rust crypto option spread instrument to convert from.
        ...
        """
        return CryptoOptionSpread.from_pyo3_c(pyo3_instrument)
