...
cdef class CryptoFuturesSpread(Instrument):
    """
    Represents a crypto deliverable futures spread instrument, with crypto assets
    ...
    strategy_type : str
        The strategy type for the spread (e.g., ``FS``).
    ...
    @staticmethod
    cdef CryptoFuturesSpread from_dict_c(dict values):
    ...
    @staticmethod
    cdef dict to_dict_c(CryptoFuturesSpread obj):
        Condition.not_none(obj, "obj")
        return {
            "type": "CryptoFuturesSpread",
            "id": obj.id.to_str(),
    ...
    @staticmethod
    cdef CryptoFuturesSpread from_pyo3_c(pyo3_instrument):
    ...
    @staticmethod
    def from_dict(dict values) -> CryptoFuturesSpread:
        """
        ...
        """
        return CryptoFuturesSpread.from_dict_c(values)

    @staticmethod
    def to_dict(CryptoFuturesSpread obj) -> dict[str, object]:
        """
        ...
        """
        return CryptoFuturesSpread.to_dict_c(obj)

    @staticmethod
    def from_pyo3(pyo3_instrument) -> CryptoFuturesSpread:
        """
        Return legacy Cython crypto futures spread instrument converted from the given pyo3 Rust object.

        Parameters
        ----------
        pyo3_instrument : nautilus_pyo3.CryptoFuturesSpread
            The pyo3 Rust crypto futures spread instrument to convert from.
        ...
        """
        return CryptoFuturesSpread.from_pyo3_c(pyo3_instrument)
