...
# -- SUBSCRIPTIONS --------------------------------------------------------------------------------
    ...
    cpdef void subscribe_order_book_depth10(self, SubscribeOrderBook command):
        """
        ...
        self._log.error(  # pragma: no cover
            ...
            f"You can implement by overriding the `subscribe_order_book_depth10` method for this client",  # pragma: no cover
        )
        raise NotImplementedError("method `subscribe_order_book_depth10` must be implemented in the subclass")
    ...
    cpdef void unsubscribe_order_book_depth10(self, UnsubscribeOrderBook command):
        """
        ...
        self._log.error(  # pragma: no cover
            ...
            f"You can implement by overriding the `unsubscribe_order_book_depth10` method for this client",  # pragma: no cover
        )
        raise NotImplementedError("method `unsubscribe_order_book_depth10` must be implemented in the subclass")
