...
DEFAULT_ORDER_ACTION_EVENT_TYPES: tuple[str, ...] = (
    "OrderInitialized",
    "OrderSubmitted",
    "OrderAccepted",
    "OrderRejected",
...
class OrderActionPersistenceActorConfig(ActorConfig, frozen=True):
    """
    Configuration for `OrderActionPersistenceActor` instances.
    """

    db_path: str
    topic: str = "events.order.*"
    event_types: tuple[str, ...] = DEFAULT_ORDER_ACTION_EVENT_TYPES
