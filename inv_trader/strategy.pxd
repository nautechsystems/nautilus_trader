...
cdef class TradeStrategy:
    ...
    cpdef void register_indicator(self, BarType bar_type, indicator, update_method, Label label)
    ...
    cdef void _repeating_timer(self, Label label, datetime alert_time, timedelta interval, datetime stop_time)
